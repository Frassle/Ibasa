...
{
    public sealed class R16G16Float : Format<Vector2h>
    {
        public R16G16Float()
        ...
        public override void GetBytes(
            Vector2h[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2h[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    }
    public sealed class R16G16UInt : Format<Vector2us>
    {
        public R16G16UInt()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        ...
        public override void GetBytes(
            Vector2us[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2us[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    ...
    public sealed class R16G16Int : Format<Vector2s>
    {
        public R16G16Int()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        ...
        public override void GetBytes(
            Vector2s[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2s[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    ...
    public sealed class R16G16Norm : Format<Vector2s>
    {
        public R16G16Norm()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
