...
{
    public sealed class R32G32B32A32Float : Format<Vector4f>
    {
        public R32G32B32A32Float()
        ...
        public override void GetBytes(
            Vector4f[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector4f[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
        ...
        //{
        //    get { return "R32G32B32A32_Float"; }
        //}

        //public override Numerics.Colord MaxValue
        //{
        //    get { return new Numerics.Colord(float.MaxValue, float.MaxValue, float.MaxValue, float.MaxValue); }
        //}

        //public override Numerics.Colord MinValue
        //{
        //    get { return new Numerics.Colord(float.MinValue, float.MinValue, float.MinValue, float.MinValue); }
        //}
        ...
        //    return (width * height * depth) * 16; //16 bytes per color
        //}
        ...
        //                BitConverter.GetBytes((float)color.A).CopyTo(bytes, byteIndex + 12);
        ...
        //                    BitConverter.ToSingle(bytes, byteIndex + 12));
    ...
    public sealed class R32G32B32A32UInt : Format<Vector4ui>
    {
        public R32G32B32A32UInt()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        }
        ...
        public override void GetBytes(
            Vector4ui[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector4ui[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
        ...
        //public override string Name
        //{
        //    get { return "R32G32B32A32_UInt"; }
        //}

        //public override Numerics.Colord MaxValue
        //{
        //    get { return new Numerics.Colord(uint.MaxValue, uint.MaxValue, uint.MaxValue, uint.MaxValue); }
        //}

        //public override Numerics.Colord MinValue
        //{
        //    get { return new Numerics.Colord(uint.MinValue, uint.MinValue, uint.MinValue, uint.MinValue); }
        //}
        ...
        //                BitConverter.GetBytes((uint)color.A).CopyTo(bytes, byteIndex + 12);
        ...
        //                    BitConverter.ToUInt32(bytes, byteIndex + 12));
    ...
    public sealed class R32G32B32A32Int : Format<Vector4i>
    {
        public R32G32B32A32Int()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        }
        public override Size3i GetPhysicalSize(Size3i size)
        ...
        public override void GetBytes(
            Vector4i[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector4i[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
        ...
        //                BitConverter.GetBytes((int)color.A).CopyTo(bytes, byteIndex + 12);
        ...
        //                    BitConverter.ToVector3Vector2i(bytes, byteIndex + 12));
