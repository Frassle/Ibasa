...
{
    public sealed class R32G32Float : Format<Vector2f>
    {
        public R32G32Float()
        ...
        public override void GetBytes(
            Vector2f[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2f[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    }
    public sealed class R32G32UInt : Format<Vector2ui>
    {
        public R32G32UInt()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        ...
        public override void GetBytes(
            Vector2ui[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2ui[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    ...
    public sealed class R32G32Int : Format<Vector2i>
    {
        public R32G32Int()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
        ...
        public override void GetBytes(
            Vector2i[] source, int index, int width, int height,
            Stream destination, int rowPitch, int slicePitch,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        ...
        public override void GetData(
            Stream source, int rowPitch, int slicePitch,
            Vector2i[] destination, int index, int width, int height,
            Boxi sourceBoxi, Point3i destinationPoint)
        {
            throw new NotImplementedException();
        }
    ...
    public sealed class R32G32 : Format<Vector2ui>
    {
        public R32G32()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
    ...
    public sealed class R32G32Norm : Format<Vector2i>
    {
        public R32G32Norm()
            : base("NotImplemented", Colord.Black, Colord.White, false)
        {
