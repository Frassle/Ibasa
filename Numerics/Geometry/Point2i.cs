...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Point
	{
		...
		public static float Distance(Point2i value1, Point2i value2)
		{
		...
		public static Point2d Transform(Point2i value, Func<int, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Point2f Transform(Point2i value, Func<int, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Point2l Transform(Point2i value, Func<int, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Point2i Transform(Point2i value, Func<int, int> transformer)
		{
