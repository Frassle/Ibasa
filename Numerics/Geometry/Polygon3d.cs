...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Polygon3d: IEquatable<Polygon3d>, IFormattable
	{
		#region Constants
		#endregion
		#region Fields
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Polygon3d"/> using the specified values.
		/// </summary>
		/// <param name="points">Points to define this polygon.</param>
		private Polygon3d(Point3d[] points)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an implicit conversion of a Polygon3f value to a Polygon3d.
		/// </summary>
		/// <param name="value">The value to convert to a Polygon3d.</param>
		/// <returns>A Polygon3d that has all components equal to value.</returns>
		public static implicit operator Polygon3d(Polygon3f value)
		{
			var points = new Point3d[value.Count];
			for (int i=0; i<points.Length; ++i)
			{
				points[i] = (Point3d)value[i];
			}
			return new Polygon3d(points);
		}
		/// <summary>
		/// Defines an implicit conversion of a Polygon3l value to a Polygon3d.
		/// </summary>
		/// <param name="value">The value to convert to a Polygon3d.</param>
		/// <returns>A Polygon3d that has all components equal to value.</returns>
		public static implicit operator Polygon3d(Polygon3l value)
		{
			var points = new Point3d[value.Count];
			for (int i=0; i<points.Length; ++i)
			{
		...
		/// <summary>
		/// Defines an implicit conversion of a Polygon3i value to a Polygon3d.
		/// </summary>
		/// <param name="value">The value to convert to a Polygon3d.</param>
		/// <returns>A Polygon3d that has all components equal to value.</returns>
		public static implicit operator Polygon3d(Polygon3i value)
		{
			var points = new Point3d[value.Count];
			for (int i=0; i<points.Length; ++i)
			{
		...
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Polygon3d"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Polygon3d"/> object or a type capable
		/// of implicit conversion to a <see cref="Polygon3d"/> object, and its value
		/// is equal to the current <see cref="Polygon3d"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Polygon3d) return Equals((Polygon3d)obj);
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public static bool operator ==(Polygon3d left, Polygon3d right)
		{
	...
	public static partial class Polygon
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Polygon3d"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Polygon3d polygon)
		{
		...
		/// <param name="right">The second polygon to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Polygon3d left, Polygon3d right)
		{
			return left == right;
		}
		#endregion
