...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix2x3f: IEquatable<Matrix2x3f>, IFormattable
	{
		...
		public Matrix2x3f(Vector3f row1, Vector3f row2)
		{
			M11 = row1.X;
			M12 = row1.Y;
			M13 = row1.Z;
		...
		{
			return new Matrix2x3f((float)value.M11, (float)value.M12, (float)value.M13, (float)value.M21, (float)value.M22, (float)value.M23);
		}
		#endregion
		#region Equatable
		/// <summary>
		...
		{
			return String.Format("[({0}, {1}, {2})({3}, {4}, {5})]", M11.ToString(format, provider), M12.ToString(format, provider), M13.ToString(format, provider), M21.ToString(format, provider), M22.ToString(format, provider), M23.ToString(format, provider));
		}
		#endregion
	}
	/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix2x3f(-value.M11, -value.M12, -value.M13, -value.M21, -value.M22, -value.M23);
		}
		public static Matrix2x3f Add(Matrix2x3f left, Matrix2x3f right)
		{
			return new Matrix2x3f(left.M11 + right.M11, left.M12 + right.M12, left.M13 + right.M13, left.M21 + right.M21, left.M22 + right.M22, left.M23 + right.M23);
		}
		...
		{
			return new Matrix2x2f(left.M11 * right.M11 + left.M12 * right.M21 + left.M13 * right.M31, left.M11 * right.M12 + left.M12 * right.M22 + left.M13 * right.M32, left.M21 * right.M11 + left.M22 * right.M21 + left.M23 * right.M31, left.M21 * right.M12 + left.M22 * right.M22 + left.M23 * right.M32);
		}
		...
		{
			return value.M11 != 0 && value.M12 != 0 && value.M13 != 0 && value.M21 != 0 && value.M22 != 0 && value.M23 != 0;
		}
		/// <summary>
		...
		{
			return predicate(value.M11) && predicate(value.M12) && predicate(value.M13) && predicate(value.M21) && predicate(value.M22) && predicate(value.M23);
		}
		/// <summary>
		...
		public static Matrix2x3d Transform(Matrix2x3f value, Func<float, double> transformer)
		{
			return new Matrix2x3d(transformer(value.M11), transformer(value.M12), transformer(value.M13), transformer(value.M21), transformer(value.M22), transformer(value.M23));
		}
		/// <summary>
		/// Transforms the elements of a matrix and returns the result.
		/// </summary>
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix2x3f Transform(Matrix2x3f value, Func<float, float> transformer)
		{
			return new Matrix2x3f(transformer(value.M11), transformer(value.M12), transformer(value.M13), transformer(value.M21), transformer(value.M22), transformer(value.M23));
		}
		#endregion
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M13, value2.M13), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M22, value2.M22), Functions.Min(value1.M23, value2.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Max(value1.M11, value2.M11), Functions.Max(value1.M12, value2.M12), Functions.Max(value1.M13, value2.M13), Functions.Max(value1.M21, value2.M21), Functions.Max(value1.M22, value2.M22), Functions.Max(value1.M23, value2.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Clamp(value.M11, min.M11, max.M11), Functions.Clamp(value.M12, min.M12, max.M12), Functions.Clamp(value.M13, min.M13, max.M13), Functions.Clamp(value.M21, min.M21, max.M21), Functions.Clamp(value.M22, min.M22, max.M22), Functions.Clamp(value.M23, min.M23, max.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3f(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3f(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix2x3f(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M21, 1 / value.M22, 1 / value.M23);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		{
			return new Matrix3x2f(matrix.M11, matrix.M21, matrix.M12, matrix.M22, matrix.M13, matrix.M23);
		}
		#endregion
	}
}
