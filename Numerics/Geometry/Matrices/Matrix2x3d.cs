...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix2x3d: IEquatable<Matrix2x3d>, IFormattable
	{
		...
		{
			return new Matrix2x3d((double)value.M11, (double)value.M12, (double)value.M13, (double)value.M21, (double)value.M22, (double)value.M23);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix2x3d(-value.M11, -value.M12, -value.M13, -value.M21, -value.M22, -value.M23);
		}
		public static Matrix2x3d Add(Matrix2x3d left, Matrix2x3d right)
		{
			return new Matrix2x3d(left.M11 + right.M11, left.M12 + right.M12, left.M13 + right.M13, left.M21 + right.M21, left.M22 + right.M22, left.M23 + right.M23);
		}
		...
		{
			return new Matrix2x2d(left.M11 * right.M11 + left.M12 * right.M21 + left.M13 * right.M31, left.M11 * right.M12 + left.M12 * right.M22 + left.M13 * right.M32, left.M21 * right.M11 + left.M22 * right.M21 + left.M23 * right.M31, left.M21 * right.M12 + left.M22 * right.M22 + left.M23 * right.M32);
		}
		public static Matrix2x3d Multiply(Matrix2x3d left, Matrix3x3d right)
		{
			return new Matrix2x3d(left.M11 * right.M11 + left.M12 * right.M21 + left.M13 * right.M31, left.M11 * right.M12 + left.M12 * right.M22 + left.M13 * right.M32, left.M11 * right.M13 + left.M12 * right.M23 + left.M13 * right.M33, left.M21 * right.M11 + left.M22 * right.M21 + left.M23 * right.M31, left.M21 * right.M12 + left.M22 * right.M22 + left.M23 * right.M32, left.M21 * right.M13 + left.M22 * right.M23 + left.M23 * right.M33);
		}
		public static Matrix2x4d Multiply(Matrix2x3d left, Matrix3x4d right)
		{
			return new Matrix2x4d(left.M11 * right.M11 + left.M12 * right.M21 + left.M13 * right.M31, left.M11 * right.M12 + left.M12 * right.M22 + left.M13 * right.M32, left.M11 * right.M13 + left.M12 * right.M23 + left.M13 * right.M33, left.M11 * right.M14 + left.M12 * right.M24 + left.M13 * right.M34, left.M21 * right.M11 + left.M22 * right.M21 + left.M23 * right.M31, left.M21 * right.M12 + left.M22 * right.M22 + left.M23 * right.M32, left.M21 * right.M13 + left.M22 * right.M23 + left.M23 * right.M33, left.M21 * right.M14 + left.M22 * right.M24 + left.M23 * right.M34);
		}
		public static Matrix2x3d Multiply(Matrix2x3d matrix, double scalar)
		{
			return new Matrix2x3d(matrix.M11 * scalar, matrix.M12 * scalar, matrix.M13 * scalar, matrix.M21 * scalar, matrix.M22 * scalar, matrix.M23 * scalar);
		}
		...
		public static Matrix2x3d Transform(Matrix2x3d value, Func<double, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix2x3f Transform(Matrix2x3d value, Func<double, float> transformer)
		{
		...
		{
			return new Matrix2x3d(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M13, value2.M13), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M22, value2.M22), Functions.Min(value1.M23, value2.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Max(value1.M11, value2.M11), Functions.Max(value1.M12, value2.M12), Functions.Max(value1.M13, value2.M13), Functions.Max(value1.M21, value2.M21), Functions.Max(value1.M22, value2.M22), Functions.Max(value1.M23, value2.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Clamp(value.M11, min.M11, max.M11), Functions.Clamp(value.M12, min.M12, max.M12), Functions.Clamp(value.M13, min.M13, max.M13), Functions.Clamp(value.M21, min.M21, max.M21), Functions.Clamp(value.M22, min.M22, max.M22), Functions.Clamp(value.M23, min.M23, max.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3d(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3d(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix2x3d(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix2x3d(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M21, 1 / value.M22, 1 / value.M23);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		{
			return new Matrix3x2d(matrix.M11, matrix.M21, matrix.M12, matrix.M22, matrix.M13, matrix.M23);
		}
		#endregion
	}
}
