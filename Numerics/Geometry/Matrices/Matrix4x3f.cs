...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix4x3f: IEquatable<Matrix4x3f>, IFormattable
	{
		...
		public Matrix4x3f(Vector3f row1, Vector3f row2, Vector3f row3, Vector3f row4)
		{
			M11 = row1.X;
			M12 = row1.Y;
			M13 = row1.Z;
		...
		{
			return new Matrix4x3f((float)value.M11, (float)value.M12, (float)value.M13, (float)value.M21, (float)value.M22, (float)value.M23, (float)value.M31, (float)value.M32, (float)value.M33, (float)value.M41, (float)value.M42, (float)value.M43);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix4x3f(-value.M11, -value.M12, -value.M13, -value.M21, -value.M22, -value.M23, -value.M31, -value.M32, -value.M33, -value.M41, -value.M42, -value.M43);
		}
		public static Matrix4x3f Add(Matrix4x3f left, Matrix4x3f right)
		{
			return new Matrix4x3f(left.M11 + right.M11, left.M12 + right.M12, left.M13 + right.M13, left.M21 + right.M21, left.M22 + right.M22, left.M23 + right.M23, left.M31 + right.M31, left.M32 + right.M32, left.M33 + right.M33, left.M41 + right.M41, left.M42 + right.M42, left.M43 + right.M43);
		}
		...
		{
			return new Matrix4x2f(left.M11 * right.M11 + left.M12 * right.M21 + left.M13 * right.M31, left.M11 * right.M12 + left.M12 * right.M22 + left.M13 * right.M32, left.M21 * right.M11 + left.M22 * right.M21 + left.M23 * right.M31, left.M21 * right.M12 + left.M22 * right.M22 + left.M23 * right.M32, left.M31 * right.M11 + left.M32 * right.M21 + left.M33 * right.M31, left.M31 * right.M12 + left.M32 * right.M22 + left.M33 * right.M32, left.M41 * right.M11 + left.M42 * right.M21 + left.M43 * right.M31, left.M41 * right.M12 + left.M42 * right.M22 + left.M43 * right.M32);
		}
		...
		public static Matrix4x3d Transform(Matrix4x3f value, Func<float, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix4x3f Transform(Matrix4x3f value, Func<float, float> transformer)
		{
		...
		{
			return new Matrix4x3f(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23), Functions.Abs(value.M31), Functions.Abs(value.M32), Functions.Abs(value.M33), Functions.Abs(value.M41), Functions.Abs(value.M42), Functions.Abs(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23), Functions.Saturate(value.M31), Functions.Saturate(value.M32), Functions.Saturate(value.M33), Functions.Saturate(value.M41), Functions.Saturate(value.M42), Functions.Saturate(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23), Functions.Ceiling(value.M31), Functions.Ceiling(value.M32), Functions.Ceiling(value.M33), Functions.Ceiling(value.M41), Functions.Ceiling(value.M42), Functions.Ceiling(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23), Functions.Floor(value.M31), Functions.Floor(value.M32), Functions.Floor(value.M33), Functions.Floor(value.M41), Functions.Floor(value.M42), Functions.Floor(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23), Functions.Truncate(value.M31), Functions.Truncate(value.M32), Functions.Truncate(value.M33), Functions.Truncate(value.M41), Functions.Truncate(value.M42), Functions.Truncate(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23), Functions.Fractional(value.M31), Functions.Fractional(value.M32), Functions.Fractional(value.M33), Functions.Fractional(value.M41), Functions.Fractional(value.M42), Functions.Fractional(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23), Functions.Round(value.M31), Functions.Round(value.M32), Functions.Round(value.M33), Functions.Round(value.M41), Functions.Round(value.M42), Functions.Round(value.M43));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x3f(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits), Functions.Round(value.M31, digits), Functions.Round(value.M32, digits), Functions.Round(value.M33, digits), Functions.Round(value.M41, digits), Functions.Round(value.M42, digits), Functions.Round(value.M43, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x3f(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode), Functions.Round(value.M31, mode), Functions.Round(value.M32, mode), Functions.Round(value.M33, mode), Functions.Round(value.M41, mode), Functions.Round(value.M42, mode), Functions.Round(value.M43, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x3f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M32, digits, mode), Functions.Round(value.M33, digits, mode), Functions.Round(value.M41, digits, mode), Functions.Round(value.M42, digits, mode), Functions.Round(value.M43, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix4x3f(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M21, 1 / value.M22, 1 / value.M23, 1 / value.M31, 1 / value.M32, 1 / value.M33, 1 / value.M41, 1 / value.M42, 1 / value.M43);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		public static Matrix3x2f Submatrix(Matrix4x3f matrix, int row, int column)
		{
			...
			if (row == 0 && column == 0)
			{
				return new Matrix3x2f(matrix.M22, matrix.M23, matrix.M32, matrix.M33, matrix.M42, matrix.M43);
			}
			else if (row == 0 && column == 1)
			{
				return new Matrix3x2f(matrix.M21, matrix.M23, matrix.M31, matrix.M33, matrix.M41, matrix.M43);
			}
			else if (row == 0 && column == 2)
			{
				return new Matrix3x2f(matrix.M21, matrix.M22, matrix.M31, matrix.M32, matrix.M41, matrix.M42);
			}
			else if (row == 1 && column == 0)
			{
				return new Matrix3x2f(matrix.M12, matrix.M13, matrix.M32, matrix.M33, matrix.M42, matrix.M43);
			}
			else if (row == 1 && column == 1)
			{
				return new Matrix3x2f(matrix.M11, matrix.M13, matrix.M31, matrix.M33, matrix.M41, matrix.M43);
			}
			else if (row == 1 && column == 2)
			{
				return new Matrix3x2f(matrix.M11, matrix.M12, matrix.M31, matrix.M32, matrix.M41, matrix.M42);
			}
			else if (row == 2 && column == 0)
			{
				return new Matrix3x2f(matrix.M12, matrix.M13, matrix.M22, matrix.M23, matrix.M42, matrix.M43);
			}
			else if (row == 2 && column == 1)
			{
				return new Matrix3x2f(matrix.M11, matrix.M13, matrix.M21, matrix.M23, matrix.M41, matrix.M43);
			}
			else if (row == 2 && column == 2)
			{
				return new Matrix3x2f(matrix.M11, matrix.M12, matrix.M21, matrix.M22, matrix.M41, matrix.M42);
			}
			else if (row == 3 && column == 0)
			{
				return new Matrix3x2f(matrix.M12, matrix.M13, matrix.M22, matrix.M23, matrix.M32, matrix.M33);
			}
			else if (row == 3 && column == 1)
			{
				return new Matrix3x2f(matrix.M11, matrix.M13, matrix.M21, matrix.M23, matrix.M31, matrix.M33);
			}
			else
			{
				return new Matrix3x2f(matrix.M11, matrix.M12, matrix.M21, matrix.M22, matrix.M31, matrix.M32);
			}
		}
		#endregion
		#region Transpose
		...
		{
			return new Matrix3x4f(matrix.M11, matrix.M21, matrix.M31, matrix.M41, matrix.M12, matrix.M22, matrix.M32, matrix.M42, matrix.M13, matrix.M23, matrix.M33, matrix.M43);
		}
		#endregion
	}
}
