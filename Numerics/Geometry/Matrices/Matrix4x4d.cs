...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix4x4d: IEquatable<Matrix4x4d>, IFormattable
	{
		...
		{
			return new Matrix4x4d((double)value.M11, (double)value.M12, (double)value.M13, (double)value.M14, (double)value.M21, (double)value.M22, (double)value.M23, (double)value.M24, (double)value.M31, (double)value.M32, (double)value.M33, (double)value.M34, (double)value.M41, (double)value.M42, (double)value.M43, (double)value.M44);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix4x4d(-value.M11, -value.M12, -value.M13, -value.M14, -value.M21, -value.M22, -value.M23, -value.M24, -value.M31, -value.M32, -value.M33, -value.M34, -value.M41, -value.M42, -value.M43, -value.M44);
		}
		...
		public static Matrix4x4d Transform(Matrix4x4d value, Func<double, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix4x4f Transform(Matrix4x4d value, Func<double, float> transformer)
		{
		...
		{
			return new Matrix4x4d(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M14), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23), Functions.Abs(value.M24), Functions.Abs(value.M31), Functions.Abs(value.M32), Functions.Abs(value.M33), Functions.Abs(value.M34), Functions.Abs(value.M41), Functions.Abs(value.M42), Functions.Abs(value.M43), Functions.Abs(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M14), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23), Functions.Saturate(value.M24), Functions.Saturate(value.M31), Functions.Saturate(value.M32), Functions.Saturate(value.M33), Functions.Saturate(value.M34), Functions.Saturate(value.M41), Functions.Saturate(value.M42), Functions.Saturate(value.M43), Functions.Saturate(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M14), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23), Functions.Ceiling(value.M24), Functions.Ceiling(value.M31), Functions.Ceiling(value.M32), Functions.Ceiling(value.M33), Functions.Ceiling(value.M34), Functions.Ceiling(value.M41), Functions.Ceiling(value.M42), Functions.Ceiling(value.M43), Functions.Ceiling(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M14), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23), Functions.Floor(value.M24), Functions.Floor(value.M31), Functions.Floor(value.M32), Functions.Floor(value.M33), Functions.Floor(value.M34), Functions.Floor(value.M41), Functions.Floor(value.M42), Functions.Floor(value.M43), Functions.Floor(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M14), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23), Functions.Truncate(value.M24), Functions.Truncate(value.M31), Functions.Truncate(value.M32), Functions.Truncate(value.M33), Functions.Truncate(value.M34), Functions.Truncate(value.M41), Functions.Truncate(value.M42), Functions.Truncate(value.M43), Functions.Truncate(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M14), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23), Functions.Fractional(value.M24), Functions.Fractional(value.M31), Functions.Fractional(value.M32), Functions.Fractional(value.M33), Functions.Fractional(value.M34), Functions.Fractional(value.M41), Functions.Fractional(value.M42), Functions.Fractional(value.M43), Functions.Fractional(value.M44));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M14), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23), Functions.Round(value.M24), Functions.Round(value.M31), Functions.Round(value.M32), Functions.Round(value.M33), Functions.Round(value.M34), Functions.Round(value.M41), Functions.Round(value.M42), Functions.Round(value.M43), Functions.Round(value.M44));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x4d(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M14, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits), Functions.Round(value.M24, digits), Functions.Round(value.M31, digits), Functions.Round(value.M32, digits), Functions.Round(value.M33, digits), Functions.Round(value.M34, digits), Functions.Round(value.M41, digits), Functions.Round(value.M42, digits), Functions.Round(value.M43, digits), Functions.Round(value.M44, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x4d(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M14, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode), Functions.Round(value.M24, mode), Functions.Round(value.M31, mode), Functions.Round(value.M32, mode), Functions.Round(value.M33, mode), Functions.Round(value.M34, mode), Functions.Round(value.M41, mode), Functions.Round(value.M42, mode), Functions.Round(value.M43, mode), Functions.Round(value.M44, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x4d(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M14, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode), Functions.Round(value.M24, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M32, digits, mode), Functions.Round(value.M33, digits, mode), Functions.Round(value.M34, digits, mode), Functions.Round(value.M41, digits, mode), Functions.Round(value.M42, digits, mode), Functions.Round(value.M43, digits, mode), Functions.Round(value.M44, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix4x4d(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M14, 1 / value.M21, 1 / value.M22, 1 / value.M23, 1 / value.M24, 1 / value.M31, 1 / value.M32, 1 / value.M33, 1 / value.M34, 1 / value.M41, 1 / value.M42, 1 / value.M43, 1 / value.M44);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		public static Matrix3x3d Submatrix(Matrix4x4d matrix, int row, int column)
		{
			...
			if (row == 0 && column == 0)
			{
				return new Matrix3x3d(matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44);
			}
			else if (row == 0 && column == 1)
			{
				return new Matrix3x3d(matrix.M21, matrix.M23, matrix.M24, matrix.M31, matrix.M33, matrix.M34, matrix.M41, matrix.M43, matrix.M44);
			}
			else if (row == 0 && column == 2)
			{
				return new Matrix3x3d(matrix.M21, matrix.M22, matrix.M24, matrix.M31, matrix.M32, matrix.M34, matrix.M41, matrix.M42, matrix.M44);
			}
			else if (row == 0 && column == 3)
			{
				return new Matrix3x3d(matrix.M21, matrix.M22, matrix.M23, matrix.M31, matrix.M32, matrix.M33, matrix.M41, matrix.M42, matrix.M43);
			}
			else if (row == 1 && column == 0)
			{
				return new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44);
			}
			else if (row == 1 && column == 1)
			{
				return new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M31, matrix.M33, matrix.M34, matrix.M41, matrix.M43, matrix.M44);
			}
			else if (row == 1 && column == 2)
			{
				return new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M31, matrix.M32, matrix.M34, matrix.M41, matrix.M42, matrix.M44);
			}
			else if (row == 1 && column == 3)
			{
				return new Matrix3x3d(matrix.M11, matrix.M12, matrix.M13, matrix.M31, matrix.M32, matrix.M33, matrix.M41, matrix.M42, matrix.M43);
			}
			else if (row == 2 && column == 0)
			{
				return new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M42, matrix.M43, matrix.M44);
			}
			else if (row == 2 && column == 1)
			{
				return new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M21, matrix.M23, matrix.M24, matrix.M41, matrix.M43, matrix.M44);
			}
			else if (row == 2 && column == 2)
			{
				return new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M21, matrix.M22, matrix.M24, matrix.M41, matrix.M42, matrix.M44);
			}
			else if (row == 2 && column == 3)
			{
				return new Matrix3x3d(matrix.M11, matrix.M12, matrix.M13, matrix.M21, matrix.M22, matrix.M23, matrix.M41, matrix.M42, matrix.M43);
			}
			else if (row == 3 && column == 0)
			{
				return new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34);
			}
			else if (row == 3 && column == 1)
			{
				return new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M21, matrix.M23, matrix.M24, matrix.M31, matrix.M33, matrix.M34);
			}
			else if (row == 3 && column == 2)
			{
				return new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M21, matrix.M22, matrix.M24, matrix.M31, matrix.M32, matrix.M34);
			}
			else
			{
		...
		{
			var cofactor00 = Determinant(new Matrix3x3d(matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44));
			var cofactor10 = -Determinant(new Matrix3x3d(matrix.M21, matrix.M23, matrix.M24, matrix.M31, matrix.M33, matrix.M34, matrix.M41, matrix.M43, matrix.M44));
			var cofactor20 = Determinant(new Matrix3x3d(matrix.M21, matrix.M22, matrix.M24, matrix.M31, matrix.M32, matrix.M34, matrix.M41, matrix.M42, matrix.M44));
			var cofactor30 = -Determinant(new Matrix3x3d(matrix.M21, matrix.M22, matrix.M23, matrix.M31, matrix.M32, matrix.M33, matrix.M41, matrix.M42, matrix.M43));
			var cofactor01 = -Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44));
			var cofactor11 = Determinant(new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M31, matrix.M33, matrix.M34, matrix.M41, matrix.M43, matrix.M44));
			var cofactor21 = -Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M31, matrix.M32, matrix.M34, matrix.M41, matrix.M42, matrix.M44));
			var cofactor31 = Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M13, matrix.M31, matrix.M32, matrix.M33, matrix.M41, matrix.M42, matrix.M43));
			var cofactor02 = Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M42, matrix.M43, matrix.M44));
			var cofactor12 = -Determinant(new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M21, matrix.M23, matrix.M24, matrix.M41, matrix.M43, matrix.M44));
			var cofactor22 = Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M21, matrix.M22, matrix.M24, matrix.M41, matrix.M42, matrix.M44));
			var cofactor32 = -Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M13, matrix.M21, matrix.M22, matrix.M23, matrix.M41, matrix.M42, matrix.M43));
			var cofactor03 = -Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34));
			var cofactor13 = Determinant(new Matrix3x3d(matrix.M11, matrix.M13, matrix.M14, matrix.M21, matrix.M23, matrix.M24, matrix.M31, matrix.M33, matrix.M34));
			var cofactor23 = -Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M14, matrix.M21, matrix.M22, matrix.M24, matrix.M31, matrix.M32, matrix.M34));
			var cofactor33 = Determinant(new Matrix3x3d(matrix.M11, matrix.M12, matrix.M13, matrix.M21, matrix.M22, matrix.M23, matrix.M31, matrix.M32, matrix.M33));
			determinant = matrix.M11 * cofactor00 + matrix.M21 * cofactor10 + matrix.M31 * cofactor20 + matrix.M41 * cofactor30;
			return new Matrix4x4d(cofactor00, cofactor10, cofactor20, cofactor30, cofactor01, cofactor11, cofactor21, cofactor31, cofactor02, cofactor12, cofactor22, cofactor32, cofactor03, cofactor13, cofactor23, cofactor33) / determinant;
		}
		/// <summary>
		/// Calculates the inverse of the specified matrix.
		/// </summary>
		...
		{
			var minor0 = Determinant(new Matrix3x3d(matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44));
			var minor1 = Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M32, matrix.M33, matrix.M34, matrix.M42, matrix.M43, matrix.M44));
			var minor2 = Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M42, matrix.M43, matrix.M44));
			var minor3 = Determinant(new Matrix3x3d(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34));
		...
		{
			return new Matrix4x4d(matrix.M11, matrix.M21, matrix.M31, matrix.M41, matrix.M12, matrix.M22, matrix.M32, matrix.M42, matrix.M13, matrix.M23, matrix.M33, matrix.M43, matrix.M14, matrix.M24, matrix.M34, matrix.M44);
		}
		#endregion
	}
}
