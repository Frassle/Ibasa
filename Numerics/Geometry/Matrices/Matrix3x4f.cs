...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix3x4f: IEquatable<Matrix3x4f>, IFormattable
	{
		...
		public Matrix3x4f(Vector4f row1, Vector4f row2, Vector4f row3)
		{
			M11 = row1.X;
			M12 = row1.Y;
			M13 = row1.Z;
		...
		{
			return new Matrix3x4f((float)value.M11, (float)value.M12, (float)value.M13, (float)value.M14, (float)value.M21, (float)value.M22, (float)value.M23, (float)value.M24, (float)value.M31, (float)value.M32, (float)value.M33, (float)value.M34);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix3x4f(-value.M11, -value.M12, -value.M13, -value.M14, -value.M21, -value.M22, -value.M23, -value.M24, -value.M31, -value.M32, -value.M33, -value.M34);
		}
		public static Matrix3x4f Add(Matrix3x4f left, Matrix3x4f right)
		{
			return new Matrix3x4f(left.M11 + right.M11, left.M12 + right.M12, left.M13 + right.M13, left.M14 + right.M14, left.M21 + right.M21, left.M22 + right.M22, left.M23 + right.M23, left.M24 + right.M24, left.M31 + right.M31, left.M32 + right.M32, left.M33 + right.M33, left.M34 + right.M34);
		}
		...
		public static Matrix3x4d Transform(Matrix3x4f value, Func<float, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix3x4f Transform(Matrix3x4f value, Func<float, float> transformer)
		{
		...
		{
			return new Matrix3x4f(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M14), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23), Functions.Abs(value.M24), Functions.Abs(value.M31), Functions.Abs(value.M32), Functions.Abs(value.M33), Functions.Abs(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M14), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23), Functions.Saturate(value.M24), Functions.Saturate(value.M31), Functions.Saturate(value.M32), Functions.Saturate(value.M33), Functions.Saturate(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M14), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23), Functions.Ceiling(value.M24), Functions.Ceiling(value.M31), Functions.Ceiling(value.M32), Functions.Ceiling(value.M33), Functions.Ceiling(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M14), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23), Functions.Floor(value.M24), Functions.Floor(value.M31), Functions.Floor(value.M32), Functions.Floor(value.M33), Functions.Floor(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M14), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23), Functions.Truncate(value.M24), Functions.Truncate(value.M31), Functions.Truncate(value.M32), Functions.Truncate(value.M33), Functions.Truncate(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M14), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23), Functions.Fractional(value.M24), Functions.Fractional(value.M31), Functions.Fractional(value.M32), Functions.Fractional(value.M33), Functions.Fractional(value.M34));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M14), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23), Functions.Round(value.M24), Functions.Round(value.M31), Functions.Round(value.M32), Functions.Round(value.M33), Functions.Round(value.M34));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x4f(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M14, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits), Functions.Round(value.M24, digits), Functions.Round(value.M31, digits), Functions.Round(value.M32, digits), Functions.Round(value.M33, digits), Functions.Round(value.M34, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x4f(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M14, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode), Functions.Round(value.M24, mode), Functions.Round(value.M31, mode), Functions.Round(value.M32, mode), Functions.Round(value.M33, mode), Functions.Round(value.M34, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x4f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M14, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode), Functions.Round(value.M24, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M32, digits, mode), Functions.Round(value.M33, digits, mode), Functions.Round(value.M34, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix3x4f(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M14, 1 / value.M21, 1 / value.M22, 1 / value.M23, 1 / value.M24, 1 / value.M31, 1 / value.M32, 1 / value.M33, 1 / value.M34);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		public static Matrix2x3f Submatrix(Matrix3x4f matrix, int row, int column)
		{
			...
			if (row == 0 && column == 0)
			{
				return new Matrix2x3f(matrix.M22, matrix.M23, matrix.M24, matrix.M32, matrix.M33, matrix.M34);
			}
			else if (row == 0 && column == 1)
			{
				return new Matrix2x3f(matrix.M21, matrix.M23, matrix.M24, matrix.M31, matrix.M33, matrix.M34);
			}
			else if (row == 0 && column == 2)
			{
				return new Matrix2x3f(matrix.M21, matrix.M22, matrix.M24, matrix.M31, matrix.M32, matrix.M34);
			}
			else if (row == 0 && column == 3)
			{
				return new Matrix2x3f(matrix.M21, matrix.M22, matrix.M23, matrix.M31, matrix.M32, matrix.M33);
			}
			else if (row == 1 && column == 0)
			{
				return new Matrix2x3f(matrix.M12, matrix.M13, matrix.M14, matrix.M32, matrix.M33, matrix.M34);
			}
			else if (row == 1 && column == 1)
			{
				return new Matrix2x3f(matrix.M11, matrix.M13, matrix.M14, matrix.M31, matrix.M33, matrix.M34);
			}
			else if (row == 1 && column == 2)
			{
				return new Matrix2x3f(matrix.M11, matrix.M12, matrix.M14, matrix.M31, matrix.M32, matrix.M34);
			}
			else if (row == 1 && column == 3)
			{
				return new Matrix2x3f(matrix.M11, matrix.M12, matrix.M13, matrix.M31, matrix.M32, matrix.M33);
			}
			else if (row == 2 && column == 0)
			{
				return new Matrix2x3f(matrix.M12, matrix.M13, matrix.M14, matrix.M22, matrix.M23, matrix.M24);
			}
			else if (row == 2 && column == 1)
			{
				return new Matrix2x3f(matrix.M11, matrix.M13, matrix.M14, matrix.M21, matrix.M23, matrix.M24);
			}
			else if (row == 2 && column == 2)
			{
				return new Matrix2x3f(matrix.M11, matrix.M12, matrix.M14, matrix.M21, matrix.M22, matrix.M24);
			}
			else
			{
				return new Matrix2x3f(matrix.M11, matrix.M12, matrix.M13, matrix.M21, matrix.M22, matrix.M23);
			}
		}
		#endregion
		#region Transpose
		...
		{
			return new Matrix4x3f(matrix.M11, matrix.M21, matrix.M31, matrix.M12, matrix.M22, matrix.M32, matrix.M13, matrix.M23, matrix.M33, matrix.M14, matrix.M24, matrix.M34);
		}
		#endregion
	}
}
