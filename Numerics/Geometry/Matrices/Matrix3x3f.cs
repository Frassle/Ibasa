...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix3x3f: IEquatable<Matrix3x3f>, IFormattable
	{
		...
		{
			return new Matrix3x3f((float)value.M11, (float)value.M12, (float)value.M13, (float)value.M21, (float)value.M22, (float)value.M23, (float)value.M31, (float)value.M32, (float)value.M33);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix3x3f(-value.M11, -value.M12, -value.M13, -value.M21, -value.M22, -value.M23, -value.M31, -value.M32, -value.M33);
		}
		public static Matrix3x3f Add(Matrix3x3f left, Matrix3x3f right)
		{
			return new Matrix3x3f(left.M11 + right.M11, left.M12 + right.M12, left.M13 + right.M13, left.M21 + right.M21, left.M22 + right.M22, left.M23 + right.M23, left.M31 + right.M31, left.M32 + right.M32, left.M33 + right.M33);
		}
		...
		public static Matrix3x3d Transform(Matrix3x3f value, Func<float, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix3x3f Transform(Matrix3x3f value, Func<float, float> transformer)
		{
		...
		{
			return new Matrix3x3f(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M13), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M23), Functions.Abs(value.M31), Functions.Abs(value.M32), Functions.Abs(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M13), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M23), Functions.Saturate(value.M31), Functions.Saturate(value.M32), Functions.Saturate(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M13), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M23), Functions.Ceiling(value.M31), Functions.Ceiling(value.M32), Functions.Ceiling(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M13), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M23), Functions.Floor(value.M31), Functions.Floor(value.M32), Functions.Floor(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M13), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M23), Functions.Truncate(value.M31), Functions.Truncate(value.M32), Functions.Truncate(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M13), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M23), Functions.Fractional(value.M31), Functions.Fractional(value.M32), Functions.Fractional(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M13), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M23), Functions.Round(value.M31), Functions.Round(value.M32), Functions.Round(value.M33));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x3f(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M13, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M23, digits), Functions.Round(value.M31, digits), Functions.Round(value.M32, digits), Functions.Round(value.M33, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x3f(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M13, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M23, mode), Functions.Round(value.M31, mode), Functions.Round(value.M32, mode), Functions.Round(value.M33, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x3f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M13, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M23, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M32, digits, mode), Functions.Round(value.M33, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix3x3f(1 / value.M11, 1 / value.M12, 1 / value.M13, 1 / value.M21, 1 / value.M22, 1 / value.M23, 1 / value.M31, 1 / value.M32, 1 / value.M33);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		public static Matrix2x2f Submatrix(Matrix3x3f matrix, int row, int column)
		{
			...
			if (row == 0 && column == 0)
			{
				return new Matrix2x2f(matrix.M22, matrix.M23, matrix.M32, matrix.M33);
			}
			else if (row == 0 && column == 1)
			{
				return new Matrix2x2f(matrix.M21, matrix.M23, matrix.M31, matrix.M33);
			}
			else if (row == 0 && column == 2)
			{
				return new Matrix2x2f(matrix.M21, matrix.M22, matrix.M31, matrix.M32);
			}
			else if (row == 1 && column == 0)
			{
				return new Matrix2x2f(matrix.M12, matrix.M13, matrix.M32, matrix.M33);
			}
			else if (row == 1 && column == 1)
			{
				return new Matrix2x2f(matrix.M11, matrix.M13, matrix.M31, matrix.M33);
			}
			else if (row == 1 && column == 2)
			{
				return new Matrix2x2f(matrix.M11, matrix.M12, matrix.M31, matrix.M32);
			}
			else if (row == 2 && column == 0)
			{
				return new Matrix2x2f(matrix.M12, matrix.M13, matrix.M22, matrix.M23);
			}
			else if (row == 2 && column == 1)
			{
				return new Matrix2x2f(matrix.M11, matrix.M13, matrix.M21, matrix.M23);
			}
			else
			{
		...
		{
			var cofactor00 = Determinant(new Matrix2x2f(matrix.M22, matrix.M23, matrix.M32, matrix.M33));
			var cofactor10 = -Determinant(new Matrix2x2f(matrix.M21, matrix.M23, matrix.M31, matrix.M33));
			var cofactor20 = Determinant(new Matrix2x2f(matrix.M21, matrix.M22, matrix.M31, matrix.M32));
			var cofactor01 = -Determinant(new Matrix2x2f(matrix.M12, matrix.M13, matrix.M32, matrix.M33));
			var cofactor11 = Determinant(new Matrix2x2f(matrix.M11, matrix.M13, matrix.M31, matrix.M33));
			var cofactor21 = -Determinant(new Matrix2x2f(matrix.M11, matrix.M12, matrix.M31, matrix.M32));
			var cofactor02 = Determinant(new Matrix2x2f(matrix.M12, matrix.M13, matrix.M22, matrix.M23));
			var cofactor12 = -Determinant(new Matrix2x2f(matrix.M11, matrix.M13, matrix.M21, matrix.M23));
			var cofactor22 = Determinant(new Matrix2x2f(matrix.M11, matrix.M12, matrix.M21, matrix.M22));
			determinant = matrix.M11 * cofactor00 + matrix.M21 * cofactor10 + matrix.M31 * cofactor20;
			return new Matrix3x3f(cofactor00, cofactor10, cofactor20, cofactor01, cofactor11, cofactor21, cofactor02, cofactor12, cofactor22) / determinant;
		}
		/// <summary>
		/// Calculates the inverse of the specified matrix.
		/// </summary>
		...
		{
			var minor0 = Determinant(new Matrix2x2f(matrix.M22, matrix.M23, matrix.M32, matrix.M33));
			var minor1 = Determinant(new Matrix2x2f(matrix.M12, matrix.M13, matrix.M32, matrix.M33));
			var minor2 = Determinant(new Matrix2x2f(matrix.M12, matrix.M13, matrix.M22, matrix.M23));
