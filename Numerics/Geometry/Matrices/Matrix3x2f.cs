...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Matrix3x2f: IEquatable<Matrix3x2f>, IFormattable
	{
		...
		public Matrix3x2f(Vector2f row1, Vector2f row2, Vector2f row3)
		{
			M11 = row1.X;
			M12 = row1.Y;
			M21 = row2.X;
		...
		{
			return new Matrix3x2f((float)value.M11, (float)value.M12, (float)value.M21, (float)value.M22, (float)value.M31, (float)value.M32);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix3x2f(-value.M11, -value.M12, -value.M21, -value.M22, -value.M31, -value.M32);
		}
		public static Matrix3x2f Add(Matrix3x2f left, Matrix3x2f right)
		{
			return new Matrix3x2f(left.M11 + right.M11, left.M12 + right.M12, left.M21 + right.M21, left.M22 + right.M22, left.M31 + right.M31, left.M32 + right.M32);
		}
		...
		{
			return new Matrix3x2f(left.M11 * right.M11 + left.M12 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M11 + left.M22 * right.M21, left.M21 * right.M12 + left.M22 * right.M22, left.M31 * right.M11 + left.M32 * right.M21, left.M31 * right.M12 + left.M32 * right.M22);
		}
		public static Matrix3x3f Multiply(Matrix3x2f left, Matrix2x3f right)
		{
			return new Matrix3x3f(left.M11 * right.M11 + left.M12 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M11 * right.M13 + left.M12 * right.M23, left.M21 * right.M11 + left.M22 * right.M21, left.M21 * right.M12 + left.M22 * right.M22, left.M21 * right.M13 + left.M22 * right.M23, left.M31 * right.M11 + left.M32 * right.M21, left.M31 * right.M12 + left.M32 * right.M22, left.M31 * right.M13 + left.M32 * right.M23);
		}
		public static Matrix3x4f Multiply(Matrix3x2f left, Matrix2x4f right)
		{
			return new Matrix3x4f(left.M11 * right.M11 + left.M12 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M11 * right.M13 + left.M12 * right.M23, left.M11 * right.M14 + left.M12 * right.M24, left.M21 * right.M11 + left.M22 * right.M21, left.M21 * right.M12 + left.M22 * right.M22, left.M21 * right.M13 + left.M22 * right.M23, left.M21 * right.M14 + left.M22 * right.M24, left.M31 * right.M11 + left.M32 * right.M21, left.M31 * right.M12 + left.M32 * right.M22, left.M31 * right.M13 + left.M32 * right.M23, left.M31 * right.M14 + left.M32 * right.M24);
		}
		public static Matrix3x2f Multiply(Matrix3x2f matrix, float scalar)
		{
			return new Matrix3x2f(matrix.M11 * scalar, matrix.M12 * scalar, matrix.M21 * scalar, matrix.M22 * scalar, matrix.M31 * scalar, matrix.M32 * scalar);
		}
		...
		public static Matrix3x2d Transform(Matrix3x2f value, Func<float, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each element.</param>
		/// <returns>The result of transforming each element of value.</returns>
		public static Matrix3x2f Transform(Matrix3x2f value, Func<float, float> transformer)
		{
		...
		{
			return new Matrix3x2f(Functions.Abs(value.M11), Functions.Abs(value.M12), Functions.Abs(value.M21), Functions.Abs(value.M22), Functions.Abs(value.M31), Functions.Abs(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M22, value2.M22), Functions.Min(value1.M31, value2.M31), Functions.Min(value1.M32, value2.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Max(value1.M11, value2.M11), Functions.Max(value1.M12, value2.M12), Functions.Max(value1.M21, value2.M21), Functions.Max(value1.M22, value2.M22), Functions.Max(value1.M31, value2.M31), Functions.Max(value1.M32, value2.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Clamp(value.M11, min.M11, max.M11), Functions.Clamp(value.M12, min.M12, max.M12), Functions.Clamp(value.M21, min.M21, max.M21), Functions.Clamp(value.M22, min.M22, max.M22), Functions.Clamp(value.M31, min.M31, max.M31), Functions.Clamp(value.M32, min.M32, max.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Saturate(value.M11), Functions.Saturate(value.M12), Functions.Saturate(value.M21), Functions.Saturate(value.M22), Functions.Saturate(value.M31), Functions.Saturate(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Ceiling(value.M11), Functions.Ceiling(value.M12), Functions.Ceiling(value.M21), Functions.Ceiling(value.M22), Functions.Ceiling(value.M31), Functions.Ceiling(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Floor(value.M11), Functions.Floor(value.M12), Functions.Floor(value.M21), Functions.Floor(value.M22), Functions.Floor(value.M31), Functions.Floor(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Truncate(value.M11), Functions.Truncate(value.M12), Functions.Truncate(value.M21), Functions.Truncate(value.M22), Functions.Truncate(value.M31), Functions.Truncate(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Fractional(value.M11), Functions.Fractional(value.M12), Functions.Fractional(value.M21), Functions.Fractional(value.M22), Functions.Fractional(value.M31), Functions.Fractional(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(Functions.Round(value.M11), Functions.Round(value.M12), Functions.Round(value.M21), Functions.Round(value.M22), Functions.Round(value.M31), Functions.Round(value.M32));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x2f(Functions.Round(value.M11, digits), Functions.Round(value.M12, digits), Functions.Round(value.M21, digits), Functions.Round(value.M22, digits), Functions.Round(value.M31, digits), Functions.Round(value.M32, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x2f(Functions.Round(value.M11, mode), Functions.Round(value.M12, mode), Functions.Round(value.M21, mode), Functions.Round(value.M22, mode), Functions.Round(value.M31, mode), Functions.Round(value.M32, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix3x2f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M32, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix3x2f(1 / value.M11, 1 / value.M12, 1 / value.M21, 1 / value.M22, 1 / value.M31, 1 / value.M32);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		{
			return new Matrix2x3f(matrix.M11, matrix.M21, matrix.M31, matrix.M12, matrix.M22, matrix.M32);
		}
		#endregion
	}
}
