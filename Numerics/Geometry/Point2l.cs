...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Point2l: IEquatable<Point2l>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns the point (0, 0).
		/// </summary>
		public static readonly Point2l Zero = new Point2l(0, 0);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 1:
						return Y;
					default:
						throw new IndexOutOfRangeException("Indices for Point2l run from 0 to 1, inclusive.");
				}
			}
		}
		public long[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Point2l"/> using the specified values.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Point2l"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the point.</param>
		public Point2l(long[] array)
		{
			if (array.Length < 2)
		...
		public Point2l(long[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			X = array[offset + 0];
		...
		public static Point2l operator +(Point2l value)
		{
			return value;
		}
		/// <summary>
		...
		public static Point2l operator +(Point2l point, Vector2l vector)
		{
		...
		/// <param name="point">The point value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Point2l operator +(Vector2l vector, Point2l point)
		{
			return Point.Add(point, vector);
		}
		/// <summary>
		...
		public static Vector2l operator -(Point2l left, Point2l right)
		{
		...
		public static Point2l operator *(Point2l left, long right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Point2l operator *(long left, Point2l right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Point2d value to a Point2l.
		/// </summary>
		/// <param name="value">The value to convert to a Point2l.</param>
		/// <returns>A Point2l that has all components equal to value.</returns>
		public static explicit operator Point2l(Point2d value)
		{
			return new Point2l((long)value.X, (long)value.Y);
		}
		/// <summary>
		/// Defines an explicit conversion of a Point2f value to a Point2l.
		/// </summary>
		/// <param name="value">The value to convert to a Point2l.</param>
		/// <returns>A Point2l that has all components equal to value.</returns>
		public static explicit operator Point2l(Point2f value)
		{
			return new Point2l((long)value.X, (long)value.Y);
		}
		/// <summary>
		/// Defines an implicit conversion of a Point2i value to a Point2l.
		/// </summary>
		/// <param name="value">The value to convert to a Point2l.</param>
		/// <returns>A Point2l that has all components equal to value.</returns>
		public static implicit operator Point2l(Point2i value)
		{
			return new Point2l((long)value.X, (long)value.Y);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector2l value to a Point2l.
		/// </summary>
		/// <param name="value">The value to convert to a Point2l.</param>
		/// <returns>A Point2l that has all components equal to value.</returns>
		public static explicit operator Point2l(Vector2l value)
		{
			return new Point2l(value.X, value.Y);
		}
		/// <summary>
		/// Defines an explicit conversion of a Point2l value to a Vector2l.
		/// </summary>
		...
		public static explicit operator Vector2l(Point2l value)
		{
		...
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Point2l"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Point2l"/> object or a type capable
		/// of implicit conversion to a <see cref="Point2l"/> object, and its value
		/// is equal to the current <see cref="Point2l"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Point2l) { return Equals((Point2l)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
	...
	public static partial class Point
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Point2l"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Point2l point)
		{
			writer.Write(point.X);
			writer.Write(point.Y);
		}
		/// <summary>
		/// Reads a <see cref="Point2l"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Point2l ReadPoint2l(this Ibasa.IO.BinaryReader reader)
		{
			return new Point2l(reader.ReadInt64(), reader.ReadInt64());
		}
		#endregion
		#region Operations
		/// <summary>
		...
		public static float Distance(Point2l value1, Point2l value2)
		{
		...
		public static bool All(Point2l value, Predicate<long> predicate)
		{
		...
		public static Point2l Min(Point2l value1, Point2l value2)
		{
			return new Point2l(Functions.Min(value1.X, value2.X), Functions.Min(value1.Y, value2.Y));
		}
		/// <summary>
