...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Point
	{
		...
		public static Point2d Map(Point2d value, Func<double, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Point2f Map(Point2d value, Func<double, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Point2l Map(Point2d value, Func<double, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Point2i Map(Point2d value, Func<double, int> mapping)
		{
		...
		public static PolarCoordinate CartesianToPolar(Point2d value)
		{
