...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Boxi: IEquatable<Boxi>, IFormattable
	{
		...
		/// </summary>
		public Point3i Minimum { get { return new Point3i(Left, Bottom, Front); } }
		/// <summary>
		/// Gets the coordinates of the maximum corner of this box.
		/// </summary>
		public Point3i Maximum { get { return new Point3i(Right, Top, Back); } }
		/// <summary>
	...
	public static partial class Box
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Boxi"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Boxi box)
		{
			writer.Write(box.X);
			writer.Write(box.Y);
			writer.Write(box.Z);
		...
		/// <summary>
		/// Reads a <see cref="Boxi"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Boxi ReadBoxi(this Ibasa.IO.BinaryReader reader)
		{
