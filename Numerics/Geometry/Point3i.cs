...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Point
	{
		...
		public static Point3d Sum(IEnumerable<Point3i> points, IEnumerable<double> weights)
		{
		...
		public static Point3d Sum(IEnumerable<Point3i> points, double weight)
		{
		...
		public static Tuple<double, double, double> CartesianToSpherical (Point3i value)
		{
		...
		public static Point3d SphericalToCartesian (Tuple<int, int, int> value)
		{
			return new Point3d(
