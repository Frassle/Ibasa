...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Quaternion
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Quaternionf"/> structure given a direction and up axis.
		/// </summary>
		/// <param name="direction">The direction vector.</param>
		/// <param name="up">The up axis.</param>
		/// <returns>The newly created quaternion.</returns>
		public static Quaternionf FromOrientation(Vector3f direction, Vector3f up)
		{
