...
{
	/// <summary>
	/// Represents a 16 component vector of uints.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	[CLSCompliant(false)]
	public struct Vector16ui: IEquatable<Vector16ui>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector16ui"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector16ui Zero = new Vector16ui(0);
		/// <summary>
		/// Returns a new <see cref="Vector16ui"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector16ui One = new Vector16ui(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 15:
						return V15;
					default:
						throw new IndexOutOfRangeException("Indices for Vector16ui run from 0 to 15, inclusive.");
				}
			}
		}
		public uint[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16ui"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector16ui(uint value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16ui"/> using the specified vector and values.
		/// </summary>
		...
		public Vector16ui(Vector2ui value, uint v2, uint v3, uint v4, uint v5, uint v6, uint v7, uint v8, uint v9, uint v10, uint v11, uint v12, uint v13, uint v14, uint v15, uint v16, uint v17)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16ui(Vector3ui value, uint v3, uint v4, uint v5, uint v6, uint v7, uint v8, uint v9, uint v10, uint v11, uint v12, uint v13, uint v14, uint v15, uint v16, uint v17, uint v18)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16ui(Vector4ui value, uint v4, uint v5, uint v6, uint v7, uint v8, uint v9, uint v10, uint v11, uint v12, uint v13, uint v14, uint v15, uint v16, uint v17, uint v18, uint v19)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16ui(Vector8ui value, uint v8, uint v9, uint v10, uint v11, uint v12, uint v13, uint v14, uint v15, uint v16, uint v17, uint v18, uint v19, uint v20, uint v21, uint v22, uint v23)
		{
			V0 = value.V0;
			V1 = value.V1;
			V2 = value.V2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16ui"/> using the specified values.
		/// </summary>
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16ui(uint v0, uint v1, uint v2, uint v3, uint v4, uint v5, uint v6, uint v7, uint v8, uint v9, uint v10, uint v11, uint v12, uint v13, uint v14, uint v15)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16ui"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector16ui(uint[] array)
		{
			if (array.Length < 2)
		...
		public Vector16ui(uint[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector16ui operator +(Vector16ui value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector16l operator -(Vector16ui value)
		{
		...
		public static Vector16ui operator +(Vector16ui left, Vector16ui right)
		{
		...
		public static Vector16ui operator *(Vector16ui left, uint right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16ui operator *(uint left, Vector16ui right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector16d value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16d value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16f value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16f value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16h value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16h value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ul value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16ul value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16l value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16l value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16i value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16i value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16us value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static implicit operator Vector16ui(Vector16us value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16s value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16s value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16b value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static implicit operator Vector16ui(Vector16b value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16sb value to a Vector16ui.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16ui.</param>
		/// <returns>A Vector16ui that has all components equal to value.</returns>
		public static explicit operator Vector16ui(Vector16sb value)
		{
			return new Vector16ui((uint)value.V0, (uint)value.V1, (uint)value.V2, (uint)value.V3, (uint)value.V4, (uint)value.V5, (uint)value.V6, (uint)value.V7, (uint)value.V8, (uint)value.V9, (uint)value.V10, (uint)value.V11, (uint)value.V12, (uint)value.V13, (uint)value.V14, (uint)value.V15);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector16ui"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector16ui"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector16ui"/> object, and its value
		/// is equal to the current <see cref="Vector16ui"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector16ui) { return Equals((Vector16ui)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector16ui other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector16ui left, Vector16ui right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector16ui"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector16ui vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector16ui"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector16ui ReadVector16ui(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector16ui(reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32(), reader.ReadUInt32());
		}
		#endregion
		#region Pack
		public static long Pack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, Vector16ui vector)
		{
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector16l Negative(Vector16ui value)
		{
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector16ui Add(Vector16ui left, Vector16ui right)
		{
			return new Vector16ui(left.V0 + right.V0, left.V1 + right.V1, left.V2 + right.V2, left.V3 + right.V3, left.V4 + right.V4, left.V5 + right.V5, left.V6 + right.V6, left.V7 + right.V7, left.V8 + right.V8, left.V9 + right.V9, left.V10 + right.V10, left.V11 + right.V11, left.V12 + right.V12, left.V13 + right.V13, left.V14 + right.V14, left.V15 + right.V15);
		}
		/// <summary>
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector16ui Subtract(Vector16ui left, Vector16ui right)
		{
			return new Vector16ui(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7, left.V8 - right.V8, left.V9 - right.V9, left.V10 - right.V10, left.V11 - right.V11, left.V12 - right.V12, left.V13 - right.V13, left.V14 - right.V14, left.V15 - right.V15);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16ui Multiply(Vector16ui vector, uint scalar)
		{
			return new Vector16ui(vector.V0 * scalar, vector.V1 * scalar, vector.V2 * scalar, vector.V3 * scalar, vector.V4 * scalar, vector.V5 * scalar, vector.V6 * scalar, vector.V7 * scalar, vector.V8 * scalar, vector.V9 * scalar, vector.V10 * scalar, vector.V11 * scalar, vector.V12 * scalar, vector.V13 * scalar, vector.V14 * scalar, vector.V15 * scalar);
		}
		/// <summary>
		/// Divides a vector by a scalar and returns the result.
		/// </summary>
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector16ui Divide(Vector16ui vector, uint scalar)
		{
			return new Vector16ui(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar, vector.V8 / scalar, vector.V9 / scalar, vector.V10 / scalar, vector.V11 / scalar, vector.V12 / scalar, vector.V13 / scalar, vector.V14 / scalar, vector.V15 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector16ui left, Vector16ui right)
		{
			return left == right;
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static uint Dot(Vector16ui left, Vector16ui right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7 + left.V8 * right.V8 + left.V9 * right.V9 + left.V10 * right.V10 + left.V11 * right.V11 + left.V12 * right.V12 + left.V13 * right.V13 + left.V14 * right.V14 + left.V15 * right.V15;
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static bool All(Vector16ui value)
		{
		...
		[CLSCompliant(false)]
		public static bool All(Vector16ui value, Predicate<uint> predicate)
		{
		...
		[CLSCompliant(false)]
		public static bool Any(Vector16ui value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0 || value.V8 != 0 || value.V9 != 0 || value.V10 != 0 || value.V11 != 0 || value.V12 != 0 || value.V13 != 0 || value.V14 != 0 || value.V15 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		[CLSCompliant(false)]
		public static bool Any(Vector16ui value, Predicate<uint> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7) || predicate(value.V8) || predicate(value.V9) || predicate(value.V10) || predicate(value.V11) || predicate(value.V12) || predicate(value.V13) || predicate(value.V14) || predicate(value.V15);
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static uint AbsoluteSquared(Vector16ui value)
		{
		...
		[CLSCompliant(false)]
		public static double Absolute(Vector16ui value)
		{
		...
		[CLSCompliant(false)]
		public static Vector16d Normalize(Vector16ui value)
		{
		...
		[CLSCompliant(false)]
		public static Vector16d Transform(Vector16ui value, Func<uint, double> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16f Transform(Vector16ui value, Func<uint, float> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16h Transform(Vector16ui value, Func<uint, Half> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16ul Transform(Vector16ui value, Func<uint, ulong> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16l Transform(Vector16ui value, Func<uint, long> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16ui Transform(Vector16ui value, Func<uint, uint> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16i Transform(Vector16ui value, Func<uint, int> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16us Transform(Vector16ui value, Func<uint, ushort> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16s Transform(Vector16ui value, Func<uint, short> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16b Transform(Vector16ui value, Func<uint, byte> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16sb Transform(Vector16ui value, Func<uint, sbyte> transformer)
		{
		...
		[CLSCompliant(false)]
		public static Vector16ui Modulate(Vector16ui left, Vector16ui right)
		{
			return new Vector16ui(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7, left.V8 * right.V8, left.V9 * right.V9, left.V10 * right.V10, left.V11 * right.V11, left.V12 * right.V12, left.V13 * right.V13, left.V14 * right.V14, left.V15 * right.V15);
		}
		/// <summary>
		...
		[CLSCompliant(false)]
		public static Vector16ui Abs(Vector16ui value)
		{
			return new Vector16ui(Functions.Abs(value.V0), Functions.Abs(value.V1), Functions.Abs(value.V2), Functions.Abs(value.V3), Functions.Abs(value.V4), Functions.Abs(value.V5), Functions.Abs(value.V6), Functions.Abs(value.V7), Functions.Abs(value.V8), Functions.Abs(value.V9), Functions.Abs(value.V10), Functions.Abs(value.V11), Functions.Abs(value.V12), Functions.Abs(value.V13), Functions.Abs(value.V14), Functions.Abs(value.V15));
		}
		/// <summary>
