...
{
	/// <summary>
	/// Represents a eight component vector of longs.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector8l: IEquatable<Vector8l>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector8l"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector8l Zero = new Vector8l(0);
		/// <summary>
		/// Returns a new <see cref="Vector8l"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector8l One = new Vector8l(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 7:
						return V7;
					default:
						throw new IndexOutOfRangeException("Indices for Vector8l run from 0 to 7, inclusive.");
				}
			}
		}
		public long[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8l"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector8l(long value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8l(Vector4l value, long v4, long v5, long v6, long v7, long v8, long v9, long v10, long v11)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8l"/> using the specified values.
		/// </summary>
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8l(long v0, long v1, long v2, long v3, long v4, long v5, long v6, long v7)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8l"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector8l(long[] array)
		{
			if (array.Length < 2)
		...
		public Vector8l(long[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector8l operator +(Vector8l value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector8l operator +(Vector8l left, Vector8l right)
		{
		...
		public static Vector8l operator *(Vector8l left, long right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector8l operator *(long left, Vector8l right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector8d value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static explicit operator Vector8l(Vector8d value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8f value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static explicit operator Vector8l(Vector8f value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8h value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static explicit operator Vector8l(Vector8h value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8ul value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8l(Vector8ul value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8ui value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector8l(Vector8ui value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8i value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static implicit operator Vector8l(Vector8i value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8us value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector8l(Vector8us value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8s value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static implicit operator Vector8l(Vector8s value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8b value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		public static implicit operator Vector8l(Vector8b value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8sb value to a Vector8l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8l.</param>
		/// <returns>A Vector8l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector8l(Vector8sb value)
		{
			return new Vector8l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector8l"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector8l"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector8l"/> object, and its value
		/// is equal to the current <see cref="Vector8l"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector8l) { return Equals((Vector8l)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector8l other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector8l left, Vector8l right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector8l"/> to a Ibasa.IO.BinaryWriter.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector8l"/> to a Ibasa.IO.BinaryReader.
		/// </summary>
		public static Vector8l ReadVector8l(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector8l(reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64());
		}
		#endregion
		#region Pack
		...
		public static Vector8l Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, long bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 64, "v0Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 64, "v1Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 64, "v2Bits must be between 0 and 64 inclusive.");
			...
			v7 &= ((1UL << v7Bits) - 1);
			return new Vector8l((long)v0, (long)v1, (long)v2, (long)v3, (long)v4, (long)v5, (long)v6, (long)v7);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		public static bool All(Vector8l value)
		{
		...
		public static float Absolute(Vector8l value)
		{
		...
		public static Vector8f Normalize(Vector8l value)
		{
		...
		public static Vector8d Transform(Vector8l value, Func<long, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8f Transform(Vector8l value, Func<long, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8h Transform(Vector8l value, Func<long, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ul Transform(Vector8l value, Func<long, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8l Transform(Vector8l value, Func<long, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ui Transform(Vector8l value, Func<long, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8i Transform(Vector8l value, Func<long, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8us Transform(Vector8l value, Func<long, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8s Transform(Vector8l value, Func<long, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8b Transform(Vector8l value, Func<long, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8sb Transform(Vector8l value, Func<long, sbyte> transformer)
		{
		...
		public static Vector8l Min(Vector8l value1, Vector8l value2)
		{
			return new Vector8l(Functions.Min(value1.V0, value2.V0), Functions.Min(value1.V1, value2.V1), Functions.Min(value1.V2, value2.V2), Functions.Min(value1.V3, value2.V3), Functions.Min(value1.V4, value2.V4), Functions.Min(value1.V5, value2.V5), Functions.Min(value1.V6, value2.V6), Functions.Min(value1.V7, value2.V7));
		}
		/// <summary>
