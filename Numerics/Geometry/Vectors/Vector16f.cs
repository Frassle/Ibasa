...
{
	/// <summary>
	/// Represents a 16 component vector of floats.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector16f: IEquatable<Vector16f>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector16f"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector16f Zero = new Vector16f(0);
		/// <summary>
		/// Returns a new <see cref="Vector16f"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector16f One = new Vector16f(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 15:
						return V15;
					default:
						throw new IndexOutOfRangeException("Indices for Vector16f run from 0 to 15, inclusive.");
				}
			}
		}
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16f"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector16f(float value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16f"/> using the specified vector and values.
		/// </summary>
		...
		public Vector16f(Vector2f value, float v2, float v3, float v4, float v5, float v6, float v7, float v8, float v9, float v10, float v11, float v12, float v13, float v14, float v15, float v16, float v17)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16f(Vector3f value, float v3, float v4, float v5, float v6, float v7, float v8, float v9, float v10, float v11, float v12, float v13, float v14, float v15, float v16, float v17, float v18)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16f(Vector4f value, float v4, float v5, float v6, float v7, float v8, float v9, float v10, float v11, float v12, float v13, float v14, float v15, float v16, float v17, float v18, float v19)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16f(Vector8f value, float v8, float v9, float v10, float v11, float v12, float v13, float v14, float v15, float v16, float v17, float v18, float v19, float v20, float v21, float v22, float v23)
		{
			V0 = value.V0;
			V1 = value.V1;
			V2 = value.V2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16f"/> using the specified values.
		/// </summary>
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16f(float v0, float v1, float v2, float v3, float v4, float v5, float v6, float v7, float v8, float v9, float v10, float v11, float v12, float v13, float v14, float v15)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16f"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector16f(float[] array)
		{
			if (array.Length < 2)
		...
		public Vector16f(float[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector16f operator +(Vector16f value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector16f operator +(Vector16f left, Vector16f right)
		{
		...
		public static Vector16f operator *(Vector16f left, float right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16f operator *(float left, Vector16f right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector16d value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static explicit operator Vector16f(Vector16d value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16h value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static implicit operator Vector16f(Vector16h value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16ul value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16f(Vector16ul value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16l value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static implicit operator Vector16f(Vector16l value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16ui value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16f(Vector16ui value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16i value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static implicit operator Vector16f(Vector16i value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16us value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16f(Vector16us value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16s value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static implicit operator Vector16f(Vector16s value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16b value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		public static implicit operator Vector16f(Vector16b value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16sb value to a Vector16f.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16f.</param>
		/// <returns>A Vector16f that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16f(Vector16sb value)
		{
			return new Vector16f((float)value.V0, (float)value.V1, (float)value.V2, (float)value.V3, (float)value.V4, (float)value.V5, (float)value.V6, (float)value.V7, (float)value.V8, (float)value.V9, (float)value.V10, (float)value.V11, (float)value.V12, (float)value.V13, (float)value.V14, (float)value.V15);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector16f"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector16f"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector16f"/> object, and its value
		/// is equal to the current <see cref="Vector16f"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector16f) { return Equals((Vector16f)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector16f other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector16f left, Vector16f right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector16f"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector16f vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector16f"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector16f ReadVector16f(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector16f(reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle(), reader.ReadSingle());
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector16f Negative(Vector16f value)
		{
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector16f Add(Vector16f left, Vector16f right)
		{
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector16f Subtract(Vector16f left, Vector16f right)
		{
			return new Vector16f(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7, left.V8 - right.V8, left.V9 - right.V9, left.V10 - right.V10, left.V11 - right.V11, left.V12 - right.V12, left.V13 - right.V13, left.V14 - right.V14, left.V15 - right.V15);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16f Multiply(Vector16f vector, float scalar)
		{
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector16f Divide(Vector16f vector, float scalar)
		{
			return new Vector16f(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar, vector.V8 / scalar, vector.V9 / scalar, vector.V10 / scalar, vector.V11 / scalar, vector.V12 / scalar, vector.V13 / scalar, vector.V14 / scalar, vector.V15 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector16f left, Vector16f right)
		{
			return left == right;
		}
		#endregion
		...
		public static float Dot(Vector16f left, Vector16f right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7 + left.V8 * right.V8 + left.V9 * right.V9 + left.V10 * right.V10 + left.V11 * right.V11 + left.V12 * right.V12 + left.V13 * right.V13 + left.V14 * right.V14 + left.V15 * right.V15;
		}
		#endregion
		...
		public static bool All(Vector16f value)
		{
		...
		public static bool All(Vector16f value, Predicate<float> predicate)
		{
		...
		public static bool Any(Vector16f value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0 || value.V8 != 0 || value.V9 != 0 || value.V10 != 0 || value.V11 != 0 || value.V12 != 0 || value.V13 != 0 || value.V14 != 0 || value.V15 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		public static bool Any(Vector16f value, Predicate<float> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7) || predicate(value.V8) || predicate(value.V9) || predicate(value.V10) || predicate(value.V11) || predicate(value.V12) || predicate(value.V13) || predicate(value.V14) || predicate(value.V15);
		}
		#endregion
		...
		public static float AbsoluteSquared(Vector16f value)
		{
		...
		public static float Absolute(Vector16f value)
		{
		...
		public static Vector16f Normalize(Vector16f value)
		{
		...
		public static Vector16d Transform(Vector16f value, Func<float, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16f Transform(Vector16f value, Func<float, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16h Transform(Vector16f value, Func<float, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ul Transform(Vector16f value, Func<float, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16l Transform(Vector16f value, Func<float, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ui Transform(Vector16f value, Func<float, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16i Transform(Vector16f value, Func<float, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16us Transform(Vector16f value, Func<float, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16s Transform(Vector16f value, Func<float, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16b Transform(Vector16f value, Func<float, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16sb Transform(Vector16f value, Func<float, sbyte> transformer)
		{
		...
		public static Vector16f Modulate(Vector16f left, Vector16f right)
		{
			return new Vector16f(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7, left.V8 * right.V8, left.V9 * right.V9, left.V10 * right.V10, left.V11 * right.V11, left.V12 * right.V12, left.V13 * right.V13, left.V14 * right.V14, left.V15 * right.V15);
		}
		/// <summary>
		...
		public static Vector16f Abs(Vector16f value)
		{
		...
		public static Vector16f Min(Vector16f value1, Vector16f value2)
		{
		...
		public static Vector16f Max(Vector16f value1, Vector16f value2)
		{
		...
		public static Vector16f Clamp(Vector16f value, Vector16f min, Vector16f max)
		{
		...
		public static Vector16f Saturate(Vector16f value)
		{
		...
		public static Vector16f Ceiling(Vector16f value)
		{
		...
		public static Vector16f Floor(Vector16f value)
		{
		...
		public static Vector16f Truncate(Vector16f value)
		{
		...
		public static Vector16f Fractional(Vector16f value)
		{
		...
		public static Vector16f Round(Vector16f value)
		{
		...
		/// <returns>The result of rounding value.</returns>
		public static Vector16f Round(Vector16f value, int digits)
		{
		...
		/// <returns>The result of rounding value.</returns>
		public static Vector16f Round(Vector16f value, MidpointRounding mode)
		{
		...
		/// <param name="mode">Specification for how to round value if it is midway between two other numbers.</param>
		/// <returns>The result of rounding value.</returns>
		public static Vector16f Round(Vector16f value, int digits, MidpointRounding mode)
		{
		...
		public static Vector16f Reciprocal(Vector16f value)
		{
		...
		public static Vector16f Barycentric(Vector16f value1, Vector16f value2, Vector16f value3, float amount1, float amount2)
		{
		...
		public static Vector16f Reflect(Vector16f vector, Vector16f normal)
		{
		...
		/// whether the original vector was close enough to the surface to hit it.</remarks>
		public static Vector16f Refract(Vector16f vector, Vector16f normal, float index)
		{
		...
		public static Vector16f Lerp(Vector16f value1, Vector16f value2, float amount)
		{
