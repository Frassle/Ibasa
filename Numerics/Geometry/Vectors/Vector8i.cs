...
{
	/// <summary>
	/// Represents a eight component vector of ints.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector8i: IEquatable<Vector8i>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector8i"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector8i Zero = new Vector8i(0);
		/// <summary>
		/// Returns a new <see cref="Vector8i"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector8i One = new Vector8i(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 7:
						return V7;
					default:
						throw new IndexOutOfRangeException("Indices for Vector8i run from 0 to 7, inclusive.");
				}
			}
		}
		public int[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8i"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector8i(int value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8i"/> using the specified vector and values.
		/// </summary>
		...
		public Vector8i(Vector2i value, int v2, int v3, int v4, int v5, int v6, int v7, int v8, int v9)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8i(Vector3i value, int v3, int v4, int v5, int v6, int v7, int v8, int v9, int v10)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8i(Vector4i value, int v4, int v5, int v6, int v7, int v8, int v9, int v10, int v11)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8i"/> using the specified values.
		/// </summary>
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8i(int v0, int v1, int v2, int v3, int v4, int v5, int v6, int v7)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8i"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector8i(int[] array)
		{
			if (array.Length < 2)
		...
		public Vector8i(int[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector8i operator +(Vector8i value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector8i operator +(Vector8i left, Vector8i right)
		{
		...
		public static Vector8i operator *(Vector8i left, int right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector8i operator *(int left, Vector8i right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector8d value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static explicit operator Vector8i(Vector8d value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8f value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static explicit operator Vector8i(Vector8f value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8h value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static explicit operator Vector8i(Vector8h value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8ul value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8i(Vector8ul value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8l value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static explicit operator Vector8i(Vector8l value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8ui value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8i(Vector8ui value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8us value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector8i(Vector8us value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8s value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static implicit operator Vector8i(Vector8s value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8b value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		public static implicit operator Vector8i(Vector8b value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector8sb value to a Vector8i.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8i.</param>
		/// <returns>A Vector8i that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector8i(Vector8sb value)
		{
			return new Vector8i((int)value.V0, (int)value.V1, (int)value.V2, (int)value.V3, (int)value.V4, (int)value.V5, (int)value.V6, (int)value.V7);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector8i"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector8i"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector8i"/> object, and its value
		/// is equal to the current <see cref="Vector8i"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector8i) { return Equals((Vector8i)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector8i other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector8i left, Vector8i right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector8i"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector8i vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector8i"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector8i ReadVector8i(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector8i(reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32(), reader.ReadInt32());
		}
		#endregion
		#region Pack
		public static long Pack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, Vector8i vector)
		{
		...
		public static Vector8i Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 32, "v0Bits must be between 0 and 32 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 32, "v1Bits must be between 0 and 32 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 32, "v2Bits must be between 0 and 32 inclusive.");
			...
			v7 &= ((1UL << v7Bits) - 1);
			return new Vector8i((int)v0, (int)v1, (int)v2, (int)v3, (int)v4, (int)v5, (int)v6, (int)v7);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector8i Negative(Vector8i value)
		{
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector8i Add(Vector8i left, Vector8i right)
		{
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector8i Subtract(Vector8i left, Vector8i right)
		{
			return new Vector8i(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector8i Multiply(Vector8i vector, int scalar)
		{
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector8i Divide(Vector8i vector, int scalar)
		{
			return new Vector8i(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector8i left, Vector8i right)
		{
			return left == right;
		}
		#endregion
		...
		public static int Dot(Vector8i left, Vector8i right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7;
		}
		#endregion
		...
		public static bool All(Vector8i value)
		{
		...
		public static bool All(Vector8i value, Predicate<int> predicate)
		{
		...
		public static bool Any(Vector8i value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		public static bool Any(Vector8i value, Predicate<int> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7);
		}
		#endregion
		...
		public static int AbsoluteSquared(Vector8i value)
		{
		...
		public static double Absolute(Vector8i value)
		{
		...
		public static Vector8d Normalize(Vector8i value)
		{
			var absolute = Absolute(value);
			if(absolute <= double.Epsilon)
			{
				return Vector8i.Zero;
			}
			else
			{
		...
		public static Vector8d Transform(Vector8i value, Func<int, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8f Transform(Vector8i value, Func<int, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8h Transform(Vector8i value, Func<int, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ul Transform(Vector8i value, Func<int, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8l Transform(Vector8i value, Func<int, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ui Transform(Vector8i value, Func<int, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8i Transform(Vector8i value, Func<int, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8us Transform(Vector8i value, Func<int, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8s Transform(Vector8i value, Func<int, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8b Transform(Vector8i value, Func<int, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8sb Transform(Vector8i value, Func<int, sbyte> transformer)
		{
		...
		public static Vector8i Modulate(Vector8i left, Vector8i right)
		{
			return new Vector8i(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7);
		}
		/// <summary>
		...
		public static Vector8i Abs(Vector8i value)
		{
			return new Vector8i(Functions.Abs(value.V0), Functions.Abs(value.V1), Functions.Abs(value.V2), Functions.Abs(value.V3), Functions.Abs(value.V4), Functions.Abs(value.V5), Functions.Abs(value.V6), Functions.Abs(value.V7));
		}
		/// <summary>
		...
		public static Vector8i Min(Vector8i value1, Vector8i value2)
		{
			return new Vector8i(Functions.Min(value1.V0, value2.V0), Functions.Min(value1.V1, value2.V1), Functions.Min(value1.V2, value2.V2), Functions.Min(value1.V3, value2.V3), Functions.Min(value1.V4, value2.V4), Functions.Min(value1.V5, value2.V5), Functions.Min(value1.V6, value2.V6), Functions.Min(value1.V7, value2.V7));
		}
		/// <summary>
		...
		public static Vector8i Max(Vector8i value1, Vector8i value2)
		{
			return new Vector8i(Functions.Max(value1.V0, value2.V0), Functions.Max(value1.V1, value2.V1), Functions.Max(value1.V2, value2.V2), Functions.Max(value1.V3, value2.V3), Functions.Max(value1.V4, value2.V4), Functions.Max(value1.V5, value2.V5), Functions.Max(value1.V6, value2.V6), Functions.Max(value1.V7, value2.V7));
		}
		/// <summary>
		...
		public static Vector8i Clamp(Vector8i value, Vector8i min, Vector8i max)
		{
			return new Vector8i(Functions.Clamp(value.V0, min.V0, max.V0), Functions.Clamp(value.V1, min.V1, max.V1), Functions.Clamp(value.V2, min.V2, max.V2), Functions.Clamp(value.V3, min.V3, max.V3), Functions.Clamp(value.V4, min.V4, max.V4), Functions.Clamp(value.V5, min.V5, max.V5), Functions.Clamp(value.V6, min.V6, max.V6), Functions.Clamp(value.V7, min.V7, max.V7));
		}
		#endregion
	}
}
