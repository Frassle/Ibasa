...
{
	/// <summary>
	/// Represents a 16 component vector of sbytes.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	[CLSCompliant(false)]
	public struct Vector16sb: IEquatable<Vector16sb>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector16sb"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector16sb Zero = new Vector16sb(0);
		/// <summary>
		/// Returns a new <see cref="Vector16sb"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector16sb One = new Vector16sb(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 15:
						return V15;
					default:
						throw new IndexOutOfRangeException("Indices for Vector16sb run from 0 to 15, inclusive.");
				}
			}
		}
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16sb"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector16sb(sbyte value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16sb"/> using the specified vector and values.
		/// </summary>
		...
		public Vector16sb(Vector2sb value, sbyte v2, sbyte v3, sbyte v4, sbyte v5, sbyte v6, sbyte v7, sbyte v8, sbyte v9, sbyte v10, sbyte v11, sbyte v12, sbyte v13, sbyte v14, sbyte v15, sbyte v16, sbyte v17)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16sb(Vector3sb value, sbyte v3, sbyte v4, sbyte v5, sbyte v6, sbyte v7, sbyte v8, sbyte v9, sbyte v10, sbyte v11, sbyte v12, sbyte v13, sbyte v14, sbyte v15, sbyte v16, sbyte v17, sbyte v18)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16sb(Vector4sb value, sbyte v4, sbyte v5, sbyte v6, sbyte v7, sbyte v8, sbyte v9, sbyte v10, sbyte v11, sbyte v12, sbyte v13, sbyte v14, sbyte v15, sbyte v16, sbyte v17, sbyte v18, sbyte v19)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16sb(Vector8sb value, sbyte v8, sbyte v9, sbyte v10, sbyte v11, sbyte v12, sbyte v13, sbyte v14, sbyte v15, sbyte v16, sbyte v17, sbyte v18, sbyte v19, sbyte v20, sbyte v21, sbyte v22, sbyte v23)
		{
			V0 = value.V0;
			V1 = value.V1;
			V2 = value.V2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16sb"/> using the specified values.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16sb"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector16sb(sbyte[] array)
		{
			if (array.Length < 2)
		...
		public Vector16sb(sbyte[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector16i operator +(Vector16sb value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector16i operator +(Vector16sb left, Vector16sb right)
		{
		...
		public static Vector16i operator *(Vector16sb left, int right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16i operator *(int left, Vector16sb right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector16d value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16d value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16f value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16f value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16h value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16h value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ul value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16ul value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16l value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16l value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ui value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16ui value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16i value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16i value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16us value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16us value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16s value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16s value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16b value to a Vector16sb.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16sb.</param>
		/// <returns>A Vector16sb that has all components equal to value.</returns>
		public static explicit operator Vector16sb(Vector16b value)
		{
			return new Vector16sb((sbyte)value.V0, (sbyte)value.V1, (sbyte)value.V2, (sbyte)value.V3, (sbyte)value.V4, (sbyte)value.V5, (sbyte)value.V6, (sbyte)value.V7, (sbyte)value.V8, (sbyte)value.V9, (sbyte)value.V10, (sbyte)value.V11, (sbyte)value.V12, (sbyte)value.V13, (sbyte)value.V14, (sbyte)value.V15);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector16sb"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector16sb"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector16sb"/> object, and its value
		/// is equal to the current <see cref="Vector16sb"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector16sb) { return Equals((Vector16sb)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector16sb other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector16sb left, Vector16sb right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector16sb"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector16sb vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector16sb"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector16sb ReadVector16sb(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector16sb(reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte(), reader.ReadSByte());
		}
		#endregion
		#region Pack
		public static long Pack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, Vector16sb vector)
		{
		...
		public static Vector16sb Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, sbyte bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 8, "v0Bits must be between 0 and 8 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 8, "v1Bits must be between 0 and 8 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 8, "v2Bits must be between 0 and 8 inclusive.");
			...
			v15 &= ((1UL << v15Bits) - 1);
			return new Vector16sb((sbyte)v0, (sbyte)v1, (sbyte)v2, (sbyte)v3, (sbyte)v4, (sbyte)v5, (sbyte)v6, (sbyte)v7, (sbyte)v8, (sbyte)v9, (sbyte)v10, (sbyte)v11, (sbyte)v12, (sbyte)v13, (sbyte)v14, (sbyte)v15);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector16i Negative(Vector16sb value)
		{
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector16i Add(Vector16sb left, Vector16sb right)
		{
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector16i Subtract(Vector16sb left, Vector16sb right)
		{
			return new Vector16i(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7, left.V8 - right.V8, left.V9 - right.V9, left.V10 - right.V10, left.V11 - right.V11, left.V12 - right.V12, left.V13 - right.V13, left.V14 - right.V14, left.V15 - right.V15);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16i Multiply(Vector16sb vector, int scalar)
		{
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector16i Divide(Vector16sb vector, int scalar)
		{
			return new Vector16i(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar, vector.V8 / scalar, vector.V9 / scalar, vector.V10 / scalar, vector.V11 / scalar, vector.V12 / scalar, vector.V13 / scalar, vector.V14 / scalar, vector.V15 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector16sb left, Vector16sb right)
		{
			return left == right;
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static int Dot(Vector16sb left, Vector16sb right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7 + left.V8 * right.V8 + left.V9 * right.V9 + left.V10 * right.V10 + left.V11 * right.V11 + left.V12 * right.V12 + left.V13 * right.V13 + left.V14 * right.V14 + left.V15 * right.V15;
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static bool All(Vector16sb value)
		{
		...
		[CLSCompliant(false)]
		public static bool All(Vector16sb value, Predicate<sbyte> predicate)
		{
		...
		[CLSCompliant(false)]
		public static bool Any(Vector16sb value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0 || value.V8 != 0 || value.V9 != 0 || value.V10 != 0 || value.V11 != 0 || value.V12 != 0 || value.V13 != 0 || value.V14 != 0 || value.V15 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		[CLSCompliant(false)]
		public static bool Any(Vector16sb value, Predicate<sbyte> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7) || predicate(value.V8) || predicate(value.V9) || predicate(value.V10) || predicate(value.V11) || predicate(value.V12) || predicate(value.V13) || predicate(value.V14) || predicate(value.V15);
		}
		#endregion
		...
		[CLSCompliant(false)]
		public static int AbsoluteSquared(Vector16sb value)
		{
		...
		[CLSCompliant(false)]
		public static float Absolute(Vector16sb value)
		{
		...
		[CLSCompliant(false)]
		public static Vector16f Normalize(Vector16sb value)
		{
			var absolute = Absolute(value);
			if(absolute <= float.Epsilon)
			{
				return Vector16sb.Zero;
			}
			else
			{
		...
		[CLSCompliant(false)]
		public static Vector16d Transform(Vector16sb value, Func<sbyte, double> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16f Transform(Vector16sb value, Func<sbyte, float> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16h Transform(Vector16sb value, Func<sbyte, Half> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16ul Transform(Vector16sb value, Func<sbyte, ulong> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16l Transform(Vector16sb value, Func<sbyte, long> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16ui Transform(Vector16sb value, Func<sbyte, uint> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16i Transform(Vector16sb value, Func<sbyte, int> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16us Transform(Vector16sb value, Func<sbyte, ushort> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16s Transform(Vector16sb value, Func<sbyte, short> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16b Transform(Vector16sb value, Func<sbyte, byte> transformer)
		{
		...
		/// <returns>The result of transforming each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector16sb Transform(Vector16sb value, Func<sbyte, sbyte> transformer)
		{
		...
		[CLSCompliant(false)]
		public static Vector16i Modulate(Vector16sb left, Vector16sb right)
		{
			return new Vector16i(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7, left.V8 * right.V8, left.V9 * right.V9, left.V10 * right.V10, left.V11 * right.V11, left.V12 * right.V12, left.V13 * right.V13, left.V14 * right.V14, left.V15 * right.V15);
		}
		/// <summary>
		...
		[CLSCompliant(false)]
		public static Vector16sb Abs(Vector16sb value)
		{
			return new Vector16sb(Functions.Abs(value.V0), Functions.Abs(value.V1), Functions.Abs(value.V2), Functions.Abs(value.V3), Functions.Abs(value.V4), Functions.Abs(value.V5), Functions.Abs(value.V6), Functions.Abs(value.V7), Functions.Abs(value.V8), Functions.Abs(value.V9), Functions.Abs(value.V10), Functions.Abs(value.V11), Functions.Abs(value.V12), Functions.Abs(value.V13), Functions.Abs(value.V14), Functions.Abs(value.V15));
		}
		/// <summary>
