...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector3i"/> to a Ibasa.IO.BinaryWriter.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector3i"/> to a Ibasa.IO.BinaryReader.
		/// </summary>
		...
		public static float Absolute(Vector3i value)
		{
		...
		public static Vector3f Normalize(Vector3i value)
		{
