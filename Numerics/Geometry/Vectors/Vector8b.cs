...
{
	/// <summary>
	/// Represents a eight component vector of bytes.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector8b: IEquatable<Vector8b>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector8b"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector8b Zero = new Vector8b(0);
		/// <summary>
		/// Returns a new <see cref="Vector8b"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector8b One = new Vector8b(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 7:
						return V7;
					default:
						throw new IndexOutOfRangeException("Indices for Vector8b run from 0 to 7, inclusive.");
				}
			}
		}
		public byte[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8b"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector8b(byte value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8b"/> using the specified values.
		/// </summary>
		...
		/// <param name="v6">Value for the V6 component of the vector.</param>
		/// <param name="v7">Value for the V7 component of the vector.</param>
		public Vector8b(byte v0, byte v1, byte v2, byte v3, byte v4, byte v5, byte v6, byte v7)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector8b"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector8b(byte[] array)
		{
			if (array.Length < 2)
		...
		public Vector8b(byte[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector8i operator +(Vector8b value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector8i operator +(Vector8b left, Vector8b right)
		{
		...
		public static Vector8i operator *(Vector8b left, int right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector8i operator *(int left, Vector8b right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector8d value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8d value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8f value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8f value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8h value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8h value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8ul value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8b(Vector8ul value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8l value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8l value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8ui value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8b(Vector8ui value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8i value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8i value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8us value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8b(Vector8us value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8s value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		public static explicit operator Vector8b(Vector8s value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector8sb value to a Vector8b.
		/// </summary>
		/// <param name="value">The value to convert to a Vector8b.</param>
		/// <returns>A Vector8b that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector8b(Vector8sb value)
		{
			return new Vector8b((byte)value.V0, (byte)value.V1, (byte)value.V2, (byte)value.V3, (byte)value.V4, (byte)value.V5, (byte)value.V6, (byte)value.V7);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector8b"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector8b"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector8b"/> object, and its value
		/// is equal to the current <see cref="Vector8b"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector8b) { return Equals((Vector8b)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector8b other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector8b left, Vector8b right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector8b"/> to a Ibasa.IO.BinaryWriter.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector8b"/> to a Ibasa.IO.BinaryReader.
		/// </summary>
		public static Vector8b ReadVector8b(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector8b(reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte(), reader.ReadByte());
		}
		#endregion
		#region Operations
		/// <summary>
		...
		public static bool All(Vector8b value)
		{
		...
		public static Vector8d Transform(Vector8b value, Func<byte, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8f Transform(Vector8b value, Func<byte, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8h Transform(Vector8b value, Func<byte, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ul Transform(Vector8b value, Func<byte, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8l Transform(Vector8b value, Func<byte, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8ui Transform(Vector8b value, Func<byte, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8i Transform(Vector8b value, Func<byte, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8us Transform(Vector8b value, Func<byte, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8s Transform(Vector8b value, Func<byte, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8b Transform(Vector8b value, Func<byte, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector8sb Transform(Vector8b value, Func<byte, sbyte> transformer)
		{
		...
		public static Vector8b Max(Vector8b value1, Vector8b value2)
		{
			return new Vector8b(Functions.Max(value1.V0, value2.V0), Functions.Max(value1.V1, value2.V1), Functions.Max(value1.V2, value2.V2), Functions.Max(value1.V3, value2.V3), Functions.Max(value1.V4, value2.V4), Functions.Max(value1.V5, value2.V5), Functions.Max(value1.V6, value2.V6), Functions.Max(value1.V7, value2.V7));
		}
		/// <summary>
