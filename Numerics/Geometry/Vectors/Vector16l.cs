...
{
	/// <summary>
	/// Represents a 16 component vector of longs.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector16l: IEquatable<Vector16l>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector16l"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector16l Zero = new Vector16l(0);
		/// <summary>
		/// Returns a new <see cref="Vector16l"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector16l One = new Vector16l(1);
		#endregion
		#region Fields
		/// <summary>
		/// The first component of the vector.
		/// </summary>
		public readonly long V0;
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 15:
						return V15;
					default:
						throw new IndexOutOfRangeException("Indices for Vector16l run from 0 to 15, inclusive.");
				}
			}
		}
		public long[] ToArray()
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16l"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector16l(long value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16l"/> using the specified vector and values.
		/// </summary>
		...
		public Vector16l(Vector2l value, long v2, long v3, long v4, long v5, long v6, long v7, long v8, long v9, long v10, long v11, long v12, long v13, long v14, long v15, long v16, long v17)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16l(Vector3l value, long v3, long v4, long v5, long v6, long v7, long v8, long v9, long v10, long v11, long v12, long v13, long v14, long v15, long v16, long v17, long v18)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16l(Vector4l value, long v4, long v5, long v6, long v7, long v8, long v9, long v10, long v11, long v12, long v13, long v14, long v15, long v16, long v17, long v18, long v19)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16l(Vector8l value, long v8, long v9, long v10, long v11, long v12, long v13, long v14, long v15, long v16, long v17, long v18, long v19, long v20, long v21, long v22, long v23)
		{
			V0 = value.V0;
			V1 = value.V1;
			V2 = value.V2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16l"/> using the specified values.
		/// </summary>
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16l(long v0, long v1, long v2, long v3, long v4, long v5, long v6, long v7, long v8, long v9, long v10, long v11, long v12, long v13, long v14, long v15)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16l"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector16l(long[] array)
		{
			if (array.Length < 2)
		...
		public Vector16l(long[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector16l operator +(Vector16l value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector16l operator +(Vector16l left, Vector16l right)
		{
		...
		public static Vector16l operator *(Vector16l left, long right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16l operator *(long left, Vector16l right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector16d value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static explicit operator Vector16l(Vector16d value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16f value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static explicit operator Vector16l(Vector16f value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16h value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static explicit operator Vector16l(Vector16h value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ul value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector16l(Vector16ul value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16ui value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16l(Vector16ui value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16i value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static implicit operator Vector16l(Vector16i value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16us value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16l(Vector16us value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16s value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static implicit operator Vector16l(Vector16s value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16b value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		public static implicit operator Vector16l(Vector16b value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16sb value to a Vector16l.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16l.</param>
		/// <returns>A Vector16l that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16l(Vector16sb value)
		{
			return new Vector16l((long)value.V0, (long)value.V1, (long)value.V2, (long)value.V3, (long)value.V4, (long)value.V5, (long)value.V6, (long)value.V7, (long)value.V8, (long)value.V9, (long)value.V10, (long)value.V11, (long)value.V12, (long)value.V13, (long)value.V14, (long)value.V15);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector16l"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector16l"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector16l"/> object, and its value
		/// is equal to the current <see cref="Vector16l"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector16l) { return Equals((Vector16l)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector16l other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector16l left, Vector16l right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector16l"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector16l vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector16l"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector16l ReadVector16l(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector16l(reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64(), reader.ReadInt64());
		}
		#endregion
		#region Pack
		public static long Pack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, Vector16l vector)
		{
		...
		public static Vector16l Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, long bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 64, "v0Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 64, "v1Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 64, "v2Bits must be between 0 and 64 inclusive.");
			...
			v15 &= ((1UL << v15Bits) - 1);
			return new Vector16l((long)v0, (long)v1, (long)v2, (long)v3, (long)v4, (long)v5, (long)v6, (long)v7, (long)v8, (long)v9, (long)v10, (long)v11, (long)v12, (long)v13, (long)v14, (long)v15);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector16l Negative(Vector16l value)
		{
			return new Vector16l(-value.V0, -value.V1, -value.V2, -value.V3, -value.V4, -value.V5, -value.V6, -value.V7, -value.V8, -value.V9, -value.V10, -value.V11, -value.V12, -value.V13, -value.V14, -value.V15);
		}
		/// <summary>
		/// Adds two vectors and returns the result.
		/// </summary>
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector16l Add(Vector16l left, Vector16l right)
		{
			return new Vector16l(left.V0 + right.V0, left.V1 + right.V1, left.V2 + right.V2, left.V3 + right.V3, left.V4 + right.V4, left.V5 + right.V5, left.V6 + right.V6, left.V7 + right.V7, left.V8 + right.V8, left.V9 + right.V9, left.V10 + right.V10, left.V11 + right.V11, left.V12 + right.V12, left.V13 + right.V13, left.V14 + right.V14, left.V15 + right.V15);
		}
		/// <summary>
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector16l Subtract(Vector16l left, Vector16l right)
		{
			return new Vector16l(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7, left.V8 - right.V8, left.V9 - right.V9, left.V10 - right.V10, left.V11 - right.V11, left.V12 - right.V12, left.V13 - right.V13, left.V14 - right.V14, left.V15 - right.V15);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16l Multiply(Vector16l vector, long scalar)
		{
			return new Vector16l(vector.V0 * scalar, vector.V1 * scalar, vector.V2 * scalar, vector.V3 * scalar, vector.V4 * scalar, vector.V5 * scalar, vector.V6 * scalar, vector.V7 * scalar, vector.V8 * scalar, vector.V9 * scalar, vector.V10 * scalar, vector.V11 * scalar, vector.V12 * scalar, vector.V13 * scalar, vector.V14 * scalar, vector.V15 * scalar);
		}
		/// <summary>
		/// Divides a vector by a scalar and returns the result.
		/// </summary>
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector16l Divide(Vector16l vector, long scalar)
		{
			return new Vector16l(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar, vector.V8 / scalar, vector.V9 / scalar, vector.V10 / scalar, vector.V11 / scalar, vector.V12 / scalar, vector.V13 / scalar, vector.V14 / scalar, vector.V15 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector16l left, Vector16l right)
		{
			return left == right;
		}
		#endregion
		...
		public static long Dot(Vector16l left, Vector16l right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7 + left.V8 * right.V8 + left.V9 * right.V9 + left.V10 * right.V10 + left.V11 * right.V11 + left.V12 * right.V12 + left.V13 * right.V13 + left.V14 * right.V14 + left.V15 * right.V15;
		}
		#endregion
		...
		public static bool All(Vector16l value)
		{
		...
		public static bool All(Vector16l value, Predicate<long> predicate)
		{
		...
		public static bool Any(Vector16l value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0 || value.V8 != 0 || value.V9 != 0 || value.V10 != 0 || value.V11 != 0 || value.V12 != 0 || value.V13 != 0 || value.V14 != 0 || value.V15 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		public static bool Any(Vector16l value, Predicate<long> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7) || predicate(value.V8) || predicate(value.V9) || predicate(value.V10) || predicate(value.V11) || predicate(value.V12) || predicate(value.V13) || predicate(value.V14) || predicate(value.V15);
		}
		#endregion
		...
		public static long AbsoluteSquared(Vector16l value)
		{
		...
		public static double Absolute(Vector16l value)
		{
		...
		public static Vector16d Normalize(Vector16l value)
		{
			var absolute = Absolute(value);
			if(absolute <= double.Epsilon)
			{
				return Vector16l.Zero;
			}
			else
			{
		...
		public static Vector16d Transform(Vector16l value, Func<long, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16f Transform(Vector16l value, Func<long, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16h Transform(Vector16l value, Func<long, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ul Transform(Vector16l value, Func<long, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16l Transform(Vector16l value, Func<long, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ui Transform(Vector16l value, Func<long, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16i Transform(Vector16l value, Func<long, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16us Transform(Vector16l value, Func<long, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16s Transform(Vector16l value, Func<long, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16b Transform(Vector16l value, Func<long, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16sb Transform(Vector16l value, Func<long, sbyte> transformer)
		{
		...
		public static Vector16l Modulate(Vector16l left, Vector16l right)
		{
			return new Vector16l(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7, left.V8 * right.V8, left.V9 * right.V9, left.V10 * right.V10, left.V11 * right.V11, left.V12 * right.V12, left.V13 * right.V13, left.V14 * right.V14, left.V15 * right.V15);
		}
		/// <summary>
		...
		public static Vector16l Abs(Vector16l value)
		{
			return new Vector16l(Functions.Abs(value.V0), Functions.Abs(value.V1), Functions.Abs(value.V2), Functions.Abs(value.V3), Functions.Abs(value.V4), Functions.Abs(value.V5), Functions.Abs(value.V6), Functions.Abs(value.V7), Functions.Abs(value.V8), Functions.Abs(value.V9), Functions.Abs(value.V10), Functions.Abs(value.V11), Functions.Abs(value.V12), Functions.Abs(value.V13), Functions.Abs(value.V14), Functions.Abs(value.V15));
		}
		/// <summary>
