...
{
	/// <summary>
	/// Represents a 16 component vector of shorts.
	/// </summary>
	[Serializable]
	[ComVisible(true)]
	[StructLayout(LayoutKind.Sequential)]
	public struct Vector16s: IEquatable<Vector16s>, IFormattable
	{
		#region Constants
		/// <summary>
		/// Returns a new <see cref="Vector16s"/> with all of its components equal to zero.
		/// </summary>
		public static readonly Vector16s Zero = new Vector16s(0);
		/// <summary>
		/// Returns a new <see cref="Vector16s"/> with all of its components equal to one.
		/// </summary>
		public static readonly Vector16s One = new Vector16s(1);
		#endregion
		#region Fields
		/// <summary>
			...
			get
			{
				switch (index)
				{
					...
					case 15:
						return V15;
					default:
						throw new IndexOutOfRangeException("Indices for Vector16s run from 0 to 15, inclusive.");
				}
			}
		}
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16s"/> using the specified value.
		/// </summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public Vector16s(short value)
		{
			V0 = value;
			V1 = value;
			V2 = value;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16s"/> using the specified vector and values.
		/// </summary>
		...
		public Vector16s(Vector2s value, short v2, short v3, short v4, short v5, short v6, short v7, short v8, short v9, short v10, short v11, short v12, short v13, short v14, short v15, short v16, short v17)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = v2;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16s(Vector3s value, short v3, short v4, short v5, short v6, short v7, short v8, short v9, short v10, short v11, short v12, short v13, short v14, short v15, short v16, short v17, short v18)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16s(Vector4s value, short v4, short v5, short v6, short v7, short v8, short v9, short v10, short v11, short v12, short v13, short v14, short v15, short v16, short v17, short v18, short v19)
		{
			V0 = value.X;
			V1 = value.Y;
			V2 = value.Z;
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16s(Vector8s value, short v8, short v9, short v10, short v11, short v12, short v13, short v14, short v15, short v16, short v17, short v18, short v19, short v20, short v21, short v22, short v23)
		{
			V0 = value.V0;
			V1 = value.V1;
			V2 = value.V2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16s"/> using the specified values.
		/// </summary>
		...
		/// <param name="v14">Value for the V14 component of the vector.</param>
		/// <param name="v15">Value for the V15 component of the vector.</param>
		public Vector16s(short v0, short v1, short v2, short v3, short v4, short v5, short v6, short v7, short v8, short v9, short v10, short v11, short v12, short v13, short v14, short v15)
		{
			V0 = v0;
			V1 = v1;
			V2 = v2;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Vector16s"/> using the specified array.
		/// </summary>
		/// <param name="array">Array of values for the vector.</param>
		public Vector16s(short[] array)
		{
			if (array.Length < 2)
		...
		public Vector16s(short[] array, int offset)
		{
			if (array.Length < 2)
				throw new ArgumentException("Not enough elements in array.", "array");
			V0 = array[offset + 0];
		...
		public static Vector16i operator +(Vector16s value)
		{
			return value;
		}
		/// <summary>
		...
		public static Vector16i operator +(Vector16s left, Vector16s right)
		{
		...
		public static Vector16i operator *(Vector16s left, int right)
		{
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16i operator *(int left, Vector16s right)
		{
		...
		#region Conversions
		/// <summary>
		/// Defines an explicit conversion of a Vector16d value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static explicit operator Vector16s(Vector16d value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16f value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static explicit operator Vector16s(Vector16f value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16h value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static explicit operator Vector16s(Vector16h value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ul value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector16s(Vector16ul value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16l value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static explicit operator Vector16s(Vector16l value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16ui value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector16s(Vector16ui value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16i value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static explicit operator Vector16s(Vector16i value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an explicit conversion of a Vector16us value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static explicit operator Vector16s(Vector16us value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16b value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		public static implicit operator Vector16s(Vector16b value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		/// <summary>
		/// Defines an implicit conversion of a Vector16sb value to a Vector16s.
		/// </summary>
		/// <param name="value">The value to convert to a Vector16s.</param>
		/// <returns>A Vector16s that has all components equal to value.</returns>
		[CLSCompliant(false)]
		public static implicit operator Vector16s(Vector16sb value)
		{
			return new Vector16s((short)value.V0, (short)value.V1, (short)value.V2, (short)value.V3, (short)value.V4, (short)value.V5, (short)value.V6, (short)value.V7, (short)value.V8, (short)value.V9, (short)value.V10, (short)value.V11, (short)value.V12, (short)value.V13, (short)value.V14, (short)value.V15);
		}
		#endregion
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Vector16s"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Vector16s"/> object or a type capable
		/// of implicit conversion to a <see cref="Vector16s"/> object, and its value
		/// is equal to the current <see cref="Vector16s"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Vector16s) { return Equals((Vector16s)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public bool Equals(Vector16s other)
		{
			return this == other;
		}
		/// <summary>
		...
		public static bool operator ==(Vector16s left, Vector16s right)
		{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector16s"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Vector16s vector)
		{
		...
		/// <summary>
		/// Reads a <see cref="Vector16s"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Vector16s ReadVector16s(this Ibasa.IO.BinaryReader reader)
		{
			return new Vector16s(reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16(), reader.ReadInt16());
		}
		#endregion
		#region Pack
		public static long Pack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, Vector16s vector)
		{
		...
		public static Vector16s Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, int v8Bits, int v9Bits, int v10Bits, int v11Bits, int v12Bits, int v13Bits, int v14Bits, int v15Bits, short bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 16, "v0Bits must be between 0 and 16 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 16, "v1Bits must be between 0 and 16 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 16, "v2Bits must be between 0 and 16 inclusive.");
			...
			v15 &= ((1UL << v15Bits) - 1);
			return new Vector16s((short)v0, (short)v1, (short)v2, (short)v3, (short)v4, (short)v5, (short)v6, (short)v7, (short)v8, (short)v9, (short)v10, (short)v11, (short)v12, (short)v13, (short)v14, (short)v15);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="value">A vector.</param>
		/// <returns>The negative of value.</returns>
		public static Vector16i Negative(Vector16s value)
		{
		...
		/// <param name="right">The second value to add.</param>
		/// <returns>The sum of left and right.</returns>
		public static Vector16i Add(Vector16s left, Vector16s right)
		{
		...
		/// <param name="right">The value to subtract (the subtrahend).</param>
		/// <returns>The result of subtracting right from left (the difference).</returns>
		public static Vector16i Subtract(Vector16s left, Vector16s right)
		{
			return new Vector16i(left.V0 - right.V0, left.V1 - right.V1, left.V2 - right.V2, left.V3 - right.V3, left.V4 - right.V4, left.V5 - right.V5, left.V6 - right.V6, left.V7 - right.V7, left.V8 - right.V8, left.V9 - right.V9, left.V10 - right.V10, left.V11 - right.V11, left.V12 - right.V12, left.V13 - right.V13, left.V14 - right.V14, left.V15 - right.V15);
		}
		/// <summary>
		...
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector16i Multiply(Vector16s vector, int scalar)
		{
		...
		/// <returns>The result of dividing left by right (the quotient).</returns>
		public static Vector16i Divide(Vector16s vector, int scalar)
		{
			return new Vector16i(vector.V0 / scalar, vector.V1 / scalar, vector.V2 / scalar, vector.V3 / scalar, vector.V4 / scalar, vector.V5 / scalar, vector.V6 / scalar, vector.V7 / scalar, vector.V8 / scalar, vector.V9 / scalar, vector.V10 / scalar, vector.V11 / scalar, vector.V12 / scalar, vector.V13 / scalar, vector.V14 / scalar, vector.V15 / scalar);
		}
		#endregion
		...
		/// <param name="right">The second vector to compare.</param>
		/// <returns>true if the left and right are equal; otherwise, false.</returns>
		public static bool Equals(Vector16s left, Vector16s right)
		{
			return left == right;
		}
		#endregion
		...
		public static int Dot(Vector16s left, Vector16s right)
		{
			return left.V0 * right.V0 + left.V1 * right.V1 + left.V2 * right.V2 + left.V3 * right.V3 + left.V4 * right.V4 + left.V5 * right.V5 + left.V6 * right.V6 + left.V7 * right.V7 + left.V8 * right.V8 + left.V9 * right.V9 + left.V10 * right.V10 + left.V11 * right.V11 + left.V12 * right.V12 + left.V13 * right.V13 + left.V14 * right.V14 + left.V15 * right.V15;
		}
		#endregion
		...
		public static bool All(Vector16s value)
		{
		...
		public static bool All(Vector16s value, Predicate<short> predicate)
		{
		...
		public static bool Any(Vector16s value)
		{
			return value.V0 != 0 || value.V1 != 0 || value.V2 != 0 || value.V3 != 0 || value.V4 != 0 || value.V5 != 0 || value.V6 != 0 || value.V7 != 0 || value.V8 != 0 || value.V9 != 0 || value.V10 != 0 || value.V11 != 0 || value.V12 != 0 || value.V13 != 0 || value.V14 != 0 || value.V15 != 0;
		}
		/// <summary>
		...
		/// predicate; otherwise, false.</returns>
		public static bool Any(Vector16s value, Predicate<short> predicate)
		{
			return predicate(value.V0) || predicate(value.V1) || predicate(value.V2) || predicate(value.V3) || predicate(value.V4) || predicate(value.V5) || predicate(value.V6) || predicate(value.V7) || predicate(value.V8) || predicate(value.V9) || predicate(value.V10) || predicate(value.V11) || predicate(value.V12) || predicate(value.V13) || predicate(value.V14) || predicate(value.V15);
		}
		#endregion
		...
		public static int AbsoluteSquared(Vector16s value)
		{
		...
		public static float Absolute(Vector16s value)
		{
		...
		public static Vector16f Normalize(Vector16s value)
		{
			var absolute = Absolute(value);
			if(absolute <= float.Epsilon)
			{
				return Vector16s.Zero;
			}
			else
			{
		...
		public static Vector16d Transform(Vector16s value, Func<short, double> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16f Transform(Vector16s value, Func<short, float> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16h Transform(Vector16s value, Func<short, Half> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ul Transform(Vector16s value, Func<short, ulong> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16l Transform(Vector16s value, Func<short, long> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16ui Transform(Vector16s value, Func<short, uint> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16i Transform(Vector16s value, Func<short, int> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16us Transform(Vector16s value, Func<short, ushort> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16s Transform(Vector16s value, Func<short, short> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16b Transform(Vector16s value, Func<short, byte> transformer)
		{
		...
		/// <param name="transformer">A transform function to apply to each component.</param>
		/// <returns>The result of transforming each component of value.</returns>
		public static Vector16sb Transform(Vector16s value, Func<short, sbyte> transformer)
		{
		...
		public static Vector16i Modulate(Vector16s left, Vector16s right)
		{
			return new Vector16i(left.V0 * right.V0, left.V1 * right.V1, left.V2 * right.V2, left.V3 * right.V3, left.V4 * right.V4, left.V5 * right.V5, left.V6 * right.V6, left.V7 * right.V7, left.V8 * right.V8, left.V9 * right.V9, left.V10 * right.V10, left.V11 * right.V11, left.V12 * right.V12, left.V13 * right.V13, left.V14 * right.V14, left.V15 * right.V15);
		}
		/// <summary>
		...
		public static Vector16s Abs(Vector16s value)
		{
			return new Vector16s(Functions.Abs(value.V0), Functions.Abs(value.V1), Functions.Abs(value.V2), Functions.Abs(value.V3), Functions.Abs(value.V4), Functions.Abs(value.V5), Functions.Abs(value.V6), Functions.Abs(value.V7), Functions.Abs(value.V8), Functions.Abs(value.V9), Functions.Abs(value.V10), Functions.Abs(value.V11), Functions.Abs(value.V12), Functions.Abs(value.V13), Functions.Abs(value.V14), Functions.Abs(value.V15));
		}
		/// <summary>
