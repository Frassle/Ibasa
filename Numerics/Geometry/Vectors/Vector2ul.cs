...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector2ul"/> to a Ibasa.IO.BinaryWriter.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector2ul"/> to a Ibasa.IO.BinaryReader.
		/// </summary>
		...
		[CLSCompliant(false)]
		public static float Absolute(Vector2ul value)
		{
		...
		[CLSCompliant(false)]
		public static Vector2f Normalize(Vector2ul value)
		{
