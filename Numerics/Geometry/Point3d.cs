...
namespace Ibasa.Numerics.Geometry
{
	...
	public static partial class Point
	{
		...
		public static Tuple<double, double, double> CartesianToSpherical (Point3d value)
		{
		...
		public static Point3d SphericalToCartesian (Tuple<double, double, double> value)
		{
			return new Point3d(
