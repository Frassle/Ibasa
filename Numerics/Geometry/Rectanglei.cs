...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Rectanglei: IEquatable<Rectanglei>, IFormattable
	{
		...
		/// </summary>
		public Point2i Minimum { get { return new Point2i(Left, Bottom); } }
		/// <summary>
		/// Gets the coordinates of the maximum corner of this rectangle.
		/// </summary>
		public Point2i Maximum { get { return new Point2i(Right, Top); } }
		/// <summary>
	...
	public static partial class Rectangle
	{
		...
		/// <summary>
		/// Reads a <see cref="Rectanglei"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		public static Rectanglei ReadRectanglei(this Ibasa.IO.BinaryReader reader)
		{
