...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Rayf: IEquatable<Rayf>, IFormattable
	{
		#region Fields
		/// <summary>
		/// Specifies the location of the ray's origin.
		/// </summary>
		public readonly Point3f Position;
		/// <summary>
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="Rayf"/> structure.
		/// </summary>
		...
		public Rayf(Point3f position, Vector3f direction)
		{
			Position = position;
			Direction = direction;
		}
		...
		#region Equatable
		/// <summary>
		/// Returns the hash code for the current <see cref="Rayf"/>.
		/// </summary>
		...
		/// <returns>true if the obj parameter is a <see cref="Rayf"/> object or a type capable
		/// of implicit conversion to a <see cref="Rayf"/> object, and its value
		/// is equal to the current <see cref="Rayf"/> object; otherwise, false.</returns>
		public override bool Equals(object obj)
		{
			if (obj is Rayf) { return Equals((Rayf)obj); }
			return false;
		}
		/// <summary>
		/// Returns a value that indicates whether the current instance and a specified
		...
		public static bool operator ==(Rayf left, Rayf right)
		{
	...
	public static partial class Ray
	{
		...
		/// <summary>
		/// Reads a <see cref="Rayf"/> to a Ibasa.IO.BinaryReader.
		/// </summary>
		public static Rayf ReadRayf(this Ibasa.IO.BinaryReader reader)
		{
			return new Rayf(Point.ReadPoint3f(reader), Vector.ReadVector3f(reader));
		}
		#endregion
		#region Equatable
		/// <summary>
		...
		public static float? Intersects(Rayf ray, Boxd box)
		{
			return null;
		...
		public static float? Intersects(Rayf ray, Sphered sphere)
		{
		...
		/// <param name="box">A box that will be tested for intersection.</param>
		/// <returns>Distance at which the ray intersects the box or null if there is no intersection.</returns>
		public static float? Intersects(Rayf ray, Boxf box)
		{
			return null;
			var invDir = Vector.Reciprocal(ray.Direction);
			bool signX = invDir.X < 0;
		...
		/// <param name="sphere">A sphere that will be tested for intersection.</param>
		/// <returns>Distance at which the ray intersects the sphere or null if there is no intersection.</returns>
		public static float? Intersects(Rayf ray, Spheref sphere)
		{
			var distance = sphere.Center - ray.Position;
			var pyth = Vector.AbsoluteSquared(distance);
			var rr = sphere.Radius * sphere.Radius;
		...
		/// <param name="box">A box that will be tested for intersection.</param>
		/// <returns>Distance at which the ray intersects the box or null if there is no intersection.</returns>
		public static float? Intersects(Rayf ray, Boxl box)
		{
			return null;
			var invDir = Vector.Reciprocal(ray.Direction);
			bool signX = invDir.X < 0;
		...
		/// <param name="sphere">A sphere that will be tested for intersection.</param>
		/// <returns>Distance at which the ray intersects the sphere or null if there is no intersection.</returns>
		public static float? Intersects(Rayf ray, Spherel sphere)
		{
			var distance = sphere.Center - ray.Position;
			var pyth = Vector.AbsoluteSquared(distance);
			var rr = sphere.Radius * sphere.Radius;
