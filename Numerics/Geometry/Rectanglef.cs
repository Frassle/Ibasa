...
namespace Ibasa.Numerics.Geometry
{
	...
	public struct Rectanglef: IEquatable<Rectanglef>, IFormattable
	{
		...
		public Point2f[] Corners
		{
			get
			{
				return new Point2f[] { new Point2f(X, Y), new Point2f(X + Width, Y), new Point2f(X + Width, Y + Height), new Point2f(X, Y + Height) };
			}
		}
		#endregion
		#region Constructors
	...
	public static partial class Rectangle
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Rectanglef"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		public static void Write(this Ibasa.IO.BinaryWriter writer, Rectanglef rectangle)
		{
