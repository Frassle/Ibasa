...
namespace Ibasa.Numerics
{
	...
	public static partial class Color
	{
		...
		public static Colorf Log(Colorf value)
		{
			return new Colorf(Functions.Log(value.R), Functions.Log(value.G), Functions.Log(value.B), Functions.Log(value.A));
		}
		/// <summary>
		...
		public static Colorf Pow(Colorf value, float power)
		{
			return new Colorf(Functions.Pow(value.R, power), Functions.Pow(value.G, power), Functions.Pow(value.B, power), Functions.Pow(value.A, power));
		}
		#endregion
