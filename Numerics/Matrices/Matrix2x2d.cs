...
namespace Ibasa.Numerics
{
	...
	public struct Matrix2x2d: IEquatable<Matrix2x2d>, IFormattable
	{
		...
		public static Matrix2x2d Scaling(double x, double y)
		{
			return new Matrix2x2d(
				x, 0,
				0, y
		...
		{
			return new Matrix2x2d((double)value.M11, (double)value.M21, (double)value.M12, (double)value.M22);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix2x2d(left.M11 * right.M11 + left.M12 * right.M21, left.M21 * right.M11 + left.M22 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M12 + left.M22 * right.M22);
		}
		...
		public static Matrix2x2d Map(Matrix2x2d value, Func<double, double> mapping)
		{
		...
		{
			return new Matrix2x2d(Functions.Abs(value.M11), Functions.Abs(value.M21), Functions.Abs(value.M12), Functions.Abs(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2d(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M22, value2.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2d(Functions.Saturate(value.M11), Functions.Saturate(value.M21), Functions.Saturate(value.M12), Functions.Saturate(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2d(Functions.Floor(value.M11), Functions.Floor(value.M21), Functions.Floor(value.M12), Functions.Floor(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2d(Functions.Round(value.M11, mode), Functions.Round(value.M21, mode), Functions.Round(value.M12, mode), Functions.Round(value.M22, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
