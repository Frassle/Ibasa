...
namespace Ibasa.Numerics
{
	...
	public struct Matrix3x2d: IEquatable<Matrix3x2d>, IFormattable
	{
		...
		{
			return new Matrix3x2d((double)value.M11, (double)value.M21, (double)value.M31, (double)value.M12, (double)value.M22, (double)value.M32);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		public static Matrix3x2d Map(Matrix3x2d value, Func<double, double> mapping)
		{
		...
		{
			return new Matrix3x2d(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M31, value2.M31), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M22, value2.M22), Functions.Min(value1.M32, value2.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2d(Functions.Floor(value.M11), Functions.Floor(value.M21), Functions.Floor(value.M31), Functions.Floor(value.M12), Functions.Floor(value.M22), Functions.Floor(value.M32));
		}
		/// <summary>
		...
		{
			return new Matrix3x2d(Functions.Round(value.M11, mode), Functions.Round(value.M21, mode), Functions.Round(value.M31, mode), Functions.Round(value.M12, mode), Functions.Round(value.M22, mode), Functions.Round(value.M32, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
