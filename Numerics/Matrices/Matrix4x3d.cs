...
namespace Ibasa.Numerics
{
	...
	public struct Matrix4x3d: IEquatable<Matrix4x3d>, IFormattable
	{
		...
		{
			return new Matrix4x3d((double)value.M11, (double)value.M21, (double)value.M31, (double)value.M41, (double)value.M12, (double)value.M22, (double)value.M32, (double)value.M42, (double)value.M13, (double)value.M23, (double)value.M33, (double)value.M43);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		public static Matrix4x3d Map(Matrix4x3d value, Func<double, double> mapping)
		{
		...
		{
			return new Matrix4x3d(Functions.Fractional(value.M11), Functions.Fractional(value.M21), Functions.Fractional(value.M31), Functions.Fractional(value.M41), Functions.Fractional(value.M12), Functions.Fractional(value.M22), Functions.Fractional(value.M32), Functions.Fractional(value.M42), Functions.Fractional(value.M13), Functions.Fractional(value.M23), Functions.Fractional(value.M33), Functions.Fractional(value.M43));
		}
		/// <summary>
		...
		{
			return new Matrix4x3d(Functions.Round(value.M11, digits), Functions.Round(value.M21, digits), Functions.Round(value.M31, digits), Functions.Round(value.M41, digits), Functions.Round(value.M12, digits), Functions.Round(value.M22, digits), Functions.Round(value.M32, digits), Functions.Round(value.M42, digits), Functions.Round(value.M13, digits), Functions.Round(value.M23, digits), Functions.Round(value.M33, digits), Functions.Round(value.M43, digits));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
		...
		{
			return new Matrix4x3d(Functions.Round(value.M11, mode), Functions.Round(value.M21, mode), Functions.Round(value.M31, mode), Functions.Round(value.M41, mode), Functions.Round(value.M12, mode), Functions.Round(value.M22, mode), Functions.Round(value.M32, mode), Functions.Round(value.M42, mode), Functions.Round(value.M13, mode), Functions.Round(value.M23, mode), Functions.Round(value.M33, mode), Functions.Round(value.M43, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
