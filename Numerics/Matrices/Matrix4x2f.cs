...
namespace Ibasa.Numerics
{
	...
	public struct Matrix4x2f: IEquatable<Matrix4x2f>, IFormattable
	{
		...
		{
			return new Matrix4x2f((float)value.M11, (float)value.M21, (float)value.M31, (float)value.M41, (float)value.M12, (float)value.M22, (float)value.M32, (float)value.M42);
		}
		#endregion
		#region Equatable
		/// <summary>
		...
		{
			return M11.GetHashCode() + M21.GetHashCode() + M31.GetHashCode() + M41.GetHashCode() + M12.GetHashCode() + M22.GetHashCode() + M32.GetHashCode() + M42.GetHashCode();
		}
		/// <summary>
		...
		{
			return left.M11 == right.M11 & left.M21 == right.M21 & left.M31 == right.M31 & left.M41 == right.M41 & left.M12 == right.M12 & left.M22 == right.M22 & left.M32 == right.M32 & left.M42 == right.M42;
		}
		/// <summary>
		...
		{
			return String.Format("[({0}, {1})({2}, {3})({4}, {5})({6}, {7})]", M11.ToString(format, provider), M21.ToString(format, provider), M31.ToString(format, provider), M41.ToString(format, provider), M12.ToString(format, provider), M22.ToString(format, provider), M32.ToString(format, provider), M42.ToString(format, provider));
		}
		#endregion
	}
	/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix4x2f(-value.M11, -value.M21, -value.M31, -value.M41, -value.M12, -value.M22, -value.M32, -value.M42);
		}
		public static Matrix4x2f Add(Matrix4x2f left, Matrix4x2f right)
		{
			return new Matrix4x2f(left.M11 + right.M11, left.M21 + right.M21, left.M31 + right.M31, left.M41 + right.M41, left.M12 + right.M12, left.M22 + right.M22, left.M32 + right.M32, left.M42 + right.M42);
		}
		...
		{
			return new Matrix4x3f(left.M11 * right.M11 + left.M12 * right.M21, left.M21 * right.M11 + left.M22 * right.M21, left.M31 * right.M11 + left.M32 * right.M21, left.M41 * right.M11 + left.M42 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M12 + left.M22 * right.M22, left.M31 * right.M12 + left.M32 * right.M22, left.M41 * right.M12 + left.M42 * right.M22, left.M11 * right.M13 + left.M12 * right.M23, left.M21 * right.M13 + left.M22 * right.M23, left.M31 * right.M13 + left.M32 * right.M23, left.M41 * right.M13 + left.M42 * right.M23);
		}
		public static Matrix4x4f Multiply(Matrix4x2f left, Matrix2x4f right)
		{
			return new Matrix4x4f(left.M11 * right.M11 + left.M12 * right.M21, left.M21 * right.M11 + left.M22 * right.M21, left.M31 * right.M11 + left.M32 * right.M21, left.M41 * right.M11 + left.M42 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M12 + left.M22 * right.M22, left.M31 * right.M12 + left.M32 * right.M22, left.M41 * right.M12 + left.M42 * right.M22, left.M11 * right.M13 + left.M12 * right.M23, left.M21 * right.M13 + left.M22 * right.M23, left.M31 * right.M13 + left.M32 * right.M23, left.M41 * right.M13 + left.M42 * right.M23, left.M11 * right.M14 + left.M12 * right.M24, left.M21 * right.M14 + left.M22 * right.M24, left.M31 * right.M14 + left.M32 * right.M24, left.M41 * right.M14 + left.M42 * right.M24);
		}
		public static Matrix4x2f Multiply(Matrix4x2f matrix, float scalar)
		{
			return new Matrix4x2f(matrix.M11 * scalar, matrix.M21 * scalar, matrix.M31 * scalar, matrix.M41 * scalar, matrix.M12 * scalar, matrix.M22 * scalar, matrix.M32 * scalar, matrix.M42 * scalar);
		}
		...
		{
			return value.M11 != 0 && value.M21 != 0 && value.M31 != 0 && value.M41 != 0 && value.M12 != 0 && value.M22 != 0 && value.M32 != 0 && value.M42 != 0;
		}
		/// <summary>
		...
		{
			return predicate(value.M11) && predicate(value.M21) && predicate(value.M31) && predicate(value.M41) && predicate(value.M12) && predicate(value.M22) && predicate(value.M32) && predicate(value.M42);
		}
		/// <summary>
		...
		public static Matrix4x2d Map(Matrix4x2f value, Func<float, double> mapping)
		{
			return new Matrix4x2d(mapping(value.M11), mapping(value.M21), mapping(value.M31), mapping(value.M41), mapping(value.M12), mapping(value.M22), mapping(value.M32), mapping(value.M42));
		}
		/// <summary>
		/// Maps the elements of a matrix and returns the result.
		/// </summary>
		...
		/// <param name="mapping">A mapping function to apply to each element.</param>
		/// <returns>The result of mapping each element of value.</returns>
		public static Matrix4x2f Map(Matrix4x2f value, Func<float, float> mapping)
		{
			return new Matrix4x2f(mapping(value.M11), mapping(value.M21), mapping(value.M31), mapping(value.M41), mapping(value.M12), mapping(value.M22), mapping(value.M32), mapping(value.M42));
		}
		#endregion
		/// <summary>
		...
		{
			return new Matrix4x2f(Functions.Clamp(value.M11, min.M11, max.M11), Functions.Clamp(value.M21, min.M21, max.M21), Functions.Clamp(value.M31, min.M31, max.M31), Functions.Clamp(value.M41, min.M41, max.M41), Functions.Clamp(value.M12, min.M12, max.M12), Functions.Clamp(value.M22, min.M22, max.M22), Functions.Clamp(value.M32, min.M32, max.M32), Functions.Clamp(value.M42, min.M42, max.M42));
		}
		/// <summary>
		...
		{
			return new Matrix4x2f(Functions.Floor(value.M11), Functions.Floor(value.M21), Functions.Floor(value.M31), Functions.Floor(value.M41), Functions.Floor(value.M12), Functions.Floor(value.M22), Functions.Floor(value.M32), Functions.Floor(value.M42));
		}
		/// <summary>
		...
		{
			return new Matrix4x2f(Functions.Fractional(value.M11), Functions.Fractional(value.M21), Functions.Fractional(value.M31), Functions.Fractional(value.M41), Functions.Fractional(value.M12), Functions.Fractional(value.M22), Functions.Fractional(value.M32), Functions.Fractional(value.M42));
		}
		/// <summary>
		...
		{
			return new Matrix4x2f(Functions.Round(value.M11, digits, mode), Functions.Round(value.M21, digits, mode), Functions.Round(value.M31, digits, mode), Functions.Round(value.M41, digits, mode), Functions.Round(value.M12, digits, mode), Functions.Round(value.M22, digits, mode), Functions.Round(value.M32, digits, mode), Functions.Round(value.M42, digits, mode));
		}
		/// <summary>
		...
		{
			return new Matrix4x2f(1 / value.M11, 1 / value.M21, 1 / value.M31, 1 / value.M41, 1 / value.M12, 1 / value.M22, 1 / value.M32, 1 / value.M42);
		}
		#endregion
		#region Submatrix
		/// <summary>
		...
		{
			return new Matrix2x4f(matrix.M11, matrix.M12, matrix.M21, matrix.M22, matrix.M31, matrix.M32, matrix.M41, matrix.M42);
		}
		#endregion
	}
}
