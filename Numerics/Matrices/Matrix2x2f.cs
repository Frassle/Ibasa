...
namespace Ibasa.Numerics
{
	...
	public struct Matrix2x2f: IEquatable<Matrix2x2f>, IFormattable
	{
		...
		public static Matrix2x2f Scaling(float x, float y)
		{
			return new Matrix2x2f(
				x, 0,
				0, y
		...
		{
			return new Matrix2x2f((float)value.M11, (float)value.M21, (float)value.M12, (float)value.M22);
		}
		#endregion
		#region Equatable
		/// <summary>
		...
		{
			return M11.GetHashCode() + M21.GetHashCode() + M12.GetHashCode() + M22.GetHashCode();
		}
		/// <summary>
		...
		{
			return left.M11 == right.M11 & left.M21 == right.M21 & left.M12 == right.M12 & left.M22 == right.M22;
		}
		/// <summary>
		...
		{
			return String.Format("[({0}, {1})({2}, {3})]", M11.ToString(format, provider), M21.ToString(format, provider), M12.ToString(format, provider), M22.ToString(format, provider));
		}
		#endregion
	}
	/// <summary>
	...
	public static partial class Matrix
	{
		...
		{
			return new Matrix2x2f(left.M11 * right.M11 + left.M12 * right.M21, left.M21 * right.M11 + left.M22 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M12 + left.M22 * right.M22);
		}
		public static Matrix2x3f Multiply(Matrix2x2f left, Matrix2x3f right)
		{
			return new Matrix2x3f(left.M11 * right.M11 + left.M12 * right.M21, left.M21 * right.M11 + left.M22 * right.M21, left.M11 * right.M12 + left.M12 * right.M22, left.M21 * right.M12 + left.M22 * right.M22, left.M11 * right.M13 + left.M12 * right.M23, left.M21 * right.M13 + left.M22 * right.M23);
		}
		...
		public static Matrix2x2d Map(Matrix2x2f value, Func<float, double> mapping)
		{
			return new Matrix2x2d(mapping(value.M11), mapping(value.M21), mapping(value.M12), mapping(value.M22));
		}
		/// <summary>
		/// Maps the elements of a matrix and returns the result.
		/// </summary>
		...
		{
			return new Matrix2x2f(Functions.Abs(value.M11), Functions.Abs(value.M21), Functions.Abs(value.M12), Functions.Abs(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2f(Functions.Min(value1.M11, value2.M11), Functions.Min(value1.M21, value2.M21), Functions.Min(value1.M12, value2.M12), Functions.Min(value1.M22, value2.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2f(Functions.Saturate(value.M11), Functions.Saturate(value.M21), Functions.Saturate(value.M12), Functions.Saturate(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2f(Functions.Floor(value.M11), Functions.Floor(value.M21), Functions.Floor(value.M12), Functions.Floor(value.M22));
		}
		/// <summary>
		...
		{
			return new Matrix2x2f(Functions.Round(value.M11, mode), Functions.Round(value.M21, mode), Functions.Round(value.M12, mode), Functions.Round(value.M22, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
