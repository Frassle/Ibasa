...
namespace Ibasa.Numerics
{
	...
	public struct Matrix3x3d: IEquatable<Matrix3x3d>, IFormattable
	{
		...
		public static Matrix3x3d Translation(double x, double y)
		{
			return new Matrix3x3d(
				1, 0, x,
				0, 1, y,
		...
		{
			return new Matrix3x3d((double)value.M11, (double)value.M21, (double)value.M31, (double)value.M12, (double)value.M22, (double)value.M32, (double)value.M13, (double)value.M23, (double)value.M33);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		public static Matrix3x3d Map(Matrix3x3d value, Func<double, double> mapping)
		{
		...
		{
			return new Matrix3x3d(Functions.Abs(value.M11), Functions.Abs(value.M21), Functions.Abs(value.M31), Functions.Abs(value.M12), Functions.Abs(value.M22), Functions.Abs(value.M32), Functions.Abs(value.M13), Functions.Abs(value.M23), Functions.Abs(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3d(Functions.Saturate(value.M11), Functions.Saturate(value.M21), Functions.Saturate(value.M31), Functions.Saturate(value.M12), Functions.Saturate(value.M22), Functions.Saturate(value.M32), Functions.Saturate(value.M13), Functions.Saturate(value.M23), Functions.Saturate(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3d(Functions.Floor(value.M11), Functions.Floor(value.M21), Functions.Floor(value.M31), Functions.Floor(value.M12), Functions.Floor(value.M22), Functions.Floor(value.M32), Functions.Floor(value.M13), Functions.Floor(value.M23), Functions.Floor(value.M33));
		}
		/// <summary>
		...
		{
			return new Matrix3x3d(Functions.Round(value.M11, mode), Functions.Round(value.M21, mode), Functions.Round(value.M31, mode), Functions.Round(value.M12, mode), Functions.Round(value.M22, mode), Functions.Round(value.M32, mode), Functions.Round(value.M13, mode), Functions.Round(value.M23, mode), Functions.Round(value.M33, mode));
		}
		/// <summary>
		/// Returns a matrix where each element is rounded to the nearest integral value.
		/// </summary>
