...
namespace Ibasa.Numerics
{
	...
	public struct Matrix3x4d: IEquatable<Matrix3x4d>, IFormattable
	{
		...
		{
			return new Matrix3x4d((double)value.M11, (double)value.M21, (double)value.M31, (double)value.M12, (double)value.M22, (double)value.M32, (double)value.M13, (double)value.M23, (double)value.M33, (double)value.M14, (double)value.M24, (double)value.M34);
		}
		#endregion
		#region Equatable
		/// <summary>
	...
	public static partial class Matrix
	{
		...
		public static Matrix3x4d Map(Matrix3x4d value, Func<double, double> mapping)
		{
		...
		{
			return new Matrix3x4d(Functions.Fractional(value.M11), Functions.Fractional(value.M21), Functions.Fractional(value.M31), Functions.Fractional(value.M12), Functions.Fractional(value.M22), Functions.Fractional(value.M32), Functions.Fractional(value.M13), Functions.Fractional(value.M23), Functions.Fractional(value.M33), Functions.Fractional(value.M14), Functions.Fractional(value.M24), Functions.Fractional(value.M34));
		}
		/// <summary>
