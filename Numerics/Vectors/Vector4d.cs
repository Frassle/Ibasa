...
namespace Ibasa.Numerics
{
	...
	public struct Vector4d: IEquatable<Vector4d>, IFormattable
	{
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d operator *(Matrix2x4d left, Vector4d right)
		{
			return new Vector2d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d operator *(Vector4d left, Matrix4x2d right)
		{
			return new Vector2d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d operator *(Matrix3x4d left, Vector4d right)
		{
			return new Vector3d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z + left.M34 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d operator *(Vector4d left, Matrix4x3d right)
		{
			return new Vector3d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33 + left.W * right.M43);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		{
			return new Vector4d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z + left.M34 * right.W, left.M41 * right.X + left.M42 * right.Y + left.M43 * right.Z + left.M44 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d operator *(Vector4d left, Matrix4x4d right)
		{
			return new Vector4d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33 + left.W * right.M43, left.X * right.M14 + left.Y * right.M24 + left.Z * right.M34 + left.W * right.M44);
		}
		/// <summary>
	...
	public static partial class Vector
	{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d Multiply(Matrix2x4d matrix, Vector4d vector)
		{
			return new Vector2d(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z + matrix.M14 * vector.W, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z + matrix.M24 * vector.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d Multiply(Matrix3x4d matrix, Vector4d vector)
		{
			return new Vector3d(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z + matrix.M14 * vector.W, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z + matrix.M24 * vector.W, matrix.M31 * vector.X + matrix.M32 * vector.Y + matrix.M33 * vector.Z + matrix.M34 * vector.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d Multiply(Matrix4x4d matrix, Vector4d vector)
		{
		...
		public static Vector4d Map(Vector4d value, Func<double, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4f Map(Vector4d value, Func<double, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4h Map(Vector4d value, Func<double, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4ul Map(Vector4d value, Func<double, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4l Map(Vector4d value, Func<double, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4ui Map(Vector4d value, Func<double, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4i Map(Vector4d value, Func<double, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4us Map(Vector4d value, Func<double, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4s Map(Vector4d value, Func<double, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4b Map(Vector4d value, Func<double, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4sb Map(Vector4d value, Func<double, sbyte> mapping)
		{
