...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector2ui"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector2ui"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		#endregion
		#region Pack
		public static ulong Pack(int xBits, int yBits, Vector2ui vector)
		{
		...
		public static ulong Pack(Vector2ui vector)
		{
			ulong x = (ulong)(vector.X) << 0;
			ulong y = (ulong)(vector.Y) << 32;
			return (ulong)(x | y);
		}
		public static Vector2ui Unpack(int xBits, int yBits, uint bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 32, "xBits must be between 0 and 32 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 32, "yBits must be between 0 and 32 inclusive.");
			Contract.Requires(xBits + yBits <= 64);
			...
			y &= ((1UL << yBits) - 1);
			return new Vector2ui((uint)x, (uint)y);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		[CLSCompliant(false)]
		public static double Absolute(Vector2ui value)
		{
		...
		[CLSCompliant(false)]
		public static Vector2d Normalize(Vector2ui value)
		{
		...
		[CLSCompliant(false)]
		public static Vector2d Map(Vector2ui value, Func<uint, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2f Map(Vector2ui value, Func<uint, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2h Map(Vector2ui value, Func<uint, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2ul Map(Vector2ui value, Func<uint, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2l Map(Vector2ui value, Func<uint, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2ui Map(Vector2ui value, Func<uint, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2i Map(Vector2ui value, Func<uint, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2us Map(Vector2ui value, Func<uint, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2s Map(Vector2ui value, Func<uint, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2b Map(Vector2ui value, Func<uint, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2sb Map(Vector2ui value, Func<uint, sbyte> mapping)
		{
		...
		[CLSCompliant(false)]
		public static PolarCoordinate CartesianToPolar(Vector2ui value)
		{
