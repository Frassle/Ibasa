...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector4ul"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector4ul"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		#endregion
		#region Pack
		public static long Pack(int xBits, int yBits, int zBits, int wBits, Vector4ul vector)
		{
		...
		public static Vector4ul Unpack(int xBits, int yBits, int zBits, int wBits, ulong bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 64, "xBits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 64, "yBits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= zBits && zBits <= 64, "zBits must be between 0 and 64 inclusive.");
			...
			w &= ((1UL << wBits) - 1);
			return new Vector4ul((ulong)x, (ulong)y, (ulong)z, (ulong)w);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		[CLSCompliant(false)]
		public static double Absolute(Vector4ul value)
		{
		...
		[CLSCompliant(false)]
		public static Vector4d Normalize(Vector4ul value)
		{
			var absolute = Absolute(value);
			if(absolute <= double.Epsilon)
			{
				return Vector4ul.Zero;
			}
			else
			{
		...
		[CLSCompliant(false)]
		public static Vector4d Map(Vector4ul value, Func<ulong, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4f Map(Vector4ul value, Func<ulong, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4h Map(Vector4ul value, Func<ulong, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4ul Map(Vector4ul value, Func<ulong, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4l Map(Vector4ul value, Func<ulong, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4ui Map(Vector4ul value, Func<ulong, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4i Map(Vector4ul value, Func<ulong, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4us Map(Vector4ul value, Func<ulong, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4s Map(Vector4ul value, Func<ulong, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4b Map(Vector4ul value, Func<ulong, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4sb Map(Vector4ul value, Func<ulong, sbyte> mapping)
		{
