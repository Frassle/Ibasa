...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		public static Vector8d Map(Vector8s value, Func<short, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8f Map(Vector8s value, Func<short, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8h Map(Vector8s value, Func<short, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8ul Map(Vector8s value, Func<short, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8l Map(Vector8s value, Func<short, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8ui Map(Vector8s value, Func<short, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8i Map(Vector8s value, Func<short, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8us Map(Vector8s value, Func<short, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8s Map(Vector8s value, Func<short, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8b Map(Vector8s value, Func<short, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8sb Map(Vector8s value, Func<short, sbyte> mapping)
		{
