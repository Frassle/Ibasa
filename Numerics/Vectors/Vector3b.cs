...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		public static Vector3d Map(Vector3b value, Func<byte, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3f Map(Vector3b value, Func<byte, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3h Map(Vector3b value, Func<byte, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ul Map(Vector3b value, Func<byte, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3l Map(Vector3b value, Func<byte, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ui Map(Vector3b value, Func<byte, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3i Map(Vector3b value, Func<byte, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3us Map(Vector3b value, Func<byte, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3s Map(Vector3b value, Func<byte, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3b Map(Vector3b value, Func<byte, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3sb Map(Vector3b value, Func<byte, sbyte> mapping)
		{
		...
		public static SphericalCoordinate CartesianToSpherical (Vector3b value)
		{
