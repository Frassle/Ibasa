...
namespace Ibasa.Numerics
{
	...
	public struct Vector2d: IEquatable<Vector2d>, IFormattable
	{
		...
		{
			return new Vector2d(left.M11 * right.X + left.M12 * right.Y, left.M21 * right.X + left.M22 * right.Y);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d operator *(Vector2d left, Matrix2x2d right)
		{
			return new Vector2d(left.X * right.M11 + left.Y * right.M21, left.X * right.M12 + left.Y * right.M22);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d operator *(Matrix3x2d left, Vector2d right)
		{
			return new Vector3d(left.M11 * right.X + left.M12 * right.Y, left.M21 * right.X + left.M22 * right.Y, left.M31 * right.X + left.M32 * right.Y);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d operator *(Vector2d left, Matrix2x3d right)
		{
			return new Vector3d(left.X * right.M11 + left.Y * right.M21, left.X * right.M12 + left.Y * right.M22, left.X * right.M13 + left.Y * right.M23);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d operator *(Matrix4x2d left, Vector2d right)
		{
			return new Vector4d(left.M11 * right.X + left.M12 * right.Y, left.M21 * right.X + left.M22 * right.Y, left.M31 * right.X + left.M32 * right.Y, left.M41 * right.X + left.M42 * right.Y);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d operator *(Vector2d left, Matrix2x4d right)
		{
			return new Vector4d(left.X * right.M11 + left.Y * right.M21, left.X * right.M12 + left.Y * right.M22, left.X * right.M13 + left.Y * right.M23, left.X * right.M14 + left.Y * right.M24);
		}
		/// <summary>
	...
	public static partial class Vector
	{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d Multiply(Matrix2x2d matrix, Vector2d vector)
		{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d Multiply(Matrix3x2d matrix, Vector2d vector)
		{
			return new Vector3d(matrix.M11 * vector.X + matrix.M12 * vector.Y, matrix.M21 * vector.X + matrix.M22 * vector.Y, matrix.M31 * vector.X + matrix.M32 * vector.Y);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d Multiply(Matrix4x2d matrix, Vector2d vector)
		{
			return new Vector4d(matrix.M11 * vector.X + matrix.M12 * vector.Y, matrix.M21 * vector.X + matrix.M22 * vector.Y, matrix.M31 * vector.X + matrix.M32 * vector.Y, matrix.M41 * vector.X + matrix.M42 * vector.Y);
		}
		/// <summary>
		/// Divides a vector by a scalar and returns the result.
		/// </summary>
		...
		public static Vector2d Map(Vector2d value, Func<double, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2f Map(Vector2d value, Func<double, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2h Map(Vector2d value, Func<double, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2ul Map(Vector2d value, Func<double, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2l Map(Vector2d value, Func<double, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2ui Map(Vector2d value, Func<double, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2i Map(Vector2d value, Func<double, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2us Map(Vector2d value, Func<double, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2s Map(Vector2d value, Func<double, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2b Map(Vector2d value, Func<double, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2sb Map(Vector2d value, Func<double, sbyte> mapping)
		{
