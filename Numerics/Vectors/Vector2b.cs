...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		/// <summary>
		/// Reads a <see cref="Vector2b"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		public static Vector2b Unpack(int xBits, int yBits, byte bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 8, "xBits must be between 0 and 8 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 8, "yBits must be between 0 and 8 inclusive.");
			Contract.Requires(xBits + yBits <= 16);
			...
			y &= ((1UL << yBits) - 1);
			return new Vector2b((byte)x, (byte)y);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2ul Map(Vector2b value, Func<byte, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2i Map(Vector2b value, Func<byte, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2s Map(Vector2b value, Func<byte, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2b Map(Vector2b value, Func<byte, byte> mapping)
		{
