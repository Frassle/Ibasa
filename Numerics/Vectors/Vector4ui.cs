...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector4ui"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector4ui"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		#endregion
		#region Pack
		public static long Pack(int xBits, int yBits, int zBits, int wBits, Vector4ui vector)
		{
		...
		public static Vector4ui Unpack(int xBits, int yBits, int zBits, int wBits, uint bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 32, "xBits must be between 0 and 32 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 32, "yBits must be between 0 and 32 inclusive.");
			Contract.Requires(0 <= zBits && zBits <= 32, "zBits must be between 0 and 32 inclusive.");
			...
			w &= ((1UL << wBits) - 1);
			return new Vector4ui((uint)x, (uint)y, (uint)z, (uint)w);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		[CLSCompliant(false)]
		public static Vector4d Map(Vector4ui value, Func<uint, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4f Map(Vector4ui value, Func<uint, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4h Map(Vector4ui value, Func<uint, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4ul Map(Vector4ui value, Func<uint, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4l Map(Vector4ui value, Func<uint, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4ui Map(Vector4ui value, Func<uint, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4i Map(Vector4ui value, Func<uint, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4us Map(Vector4ui value, Func<uint, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4s Map(Vector4ui value, Func<uint, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4b Map(Vector4ui value, Func<uint, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector4sb Map(Vector4ui value, Func<uint, sbyte> mapping)
		{
