...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		/// <summary>
		/// Reads a <see cref="Vector2h"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2h Map(Vector2h value, Func<Half, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2ul Map(Vector2h value, Func<Half, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2ui Map(Vector2h value, Func<Half, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2us Map(Vector2h value, Func<Half, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2b Map(Vector2h value, Func<Half, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector2sb Map(Vector2h value, Func<Half, sbyte> mapping)
		{
