...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector8ul"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector8ul"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		public static Vector8ul Unpack(int v0Bits, int v1Bits, int v2Bits, int v3Bits, int v4Bits, int v5Bits, int v6Bits, int v7Bits, ulong bits)
		{
			Contract.Requires(0 <= v0Bits && v0Bits <= 64, "v0Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v1Bits && v1Bits <= 64, "v1Bits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= v2Bits && v2Bits <= 64, "v2Bits must be between 0 and 64 inclusive.");
			...
			v7 &= ((1UL << v7Bits) - 1);
			return new Vector8ul((ulong)v0, (ulong)v1, (ulong)v2, (ulong)v3, (ulong)v4, (ulong)v5, (ulong)v6, (ulong)v7);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		[CLSCompliant(false)]
		public static double Absolute(Vector8ul value)
		{
		...
		[CLSCompliant(false)]
		public static Vector8d Normalize(Vector8ul value)
		{
			var absolute = Absolute(value);
			if(absolute <= double.Epsilon)
			{
				return Vector8ul.Zero;
			}
			else
			{
		...
		[CLSCompliant(false)]
		public static Vector8d Map(Vector8ul value, Func<ulong, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8f Map(Vector8ul value, Func<ulong, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8h Map(Vector8ul value, Func<ulong, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8ul Map(Vector8ul value, Func<ulong, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8l Map(Vector8ul value, Func<ulong, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8ui Map(Vector8ul value, Func<ulong, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8i Map(Vector8ul value, Func<ulong, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8us Map(Vector8ul value, Func<ulong, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8s Map(Vector8ul value, Func<ulong, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8b Map(Vector8ul value, Func<ulong, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector8sb Map(Vector8ul value, Func<ulong, sbyte> mapping)
		{
