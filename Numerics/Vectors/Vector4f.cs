...
namespace Ibasa.Numerics
{
	...
	public struct Vector4f: IEquatable<Vector4f>, IFormattable
	{
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f operator *(Matrix2x4f left, Vector4f right)
		{
			return new Vector2f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f operator *(Vector4f left, Matrix4x2f right)
		{
			return new Vector2f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3f operator *(Matrix3x4f left, Vector4f right)
		{
			return new Vector3f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z + left.M34 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3f operator *(Vector4f left, Matrix4x3f right)
		{
			return new Vector3f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33 + left.W * right.M43);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f operator *(Matrix4x4f left, Vector4f right)
		{
			return new Vector4f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z + left.M14 * right.W, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z + left.M24 * right.W, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z + left.M34 * right.W, left.M41 * right.X + left.M42 * right.Y + left.M43 * right.Z + left.M44 * right.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f operator *(Vector4f left, Matrix4x4f right)
		{
			return new Vector4f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31 + left.W * right.M41, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32 + left.W * right.M42, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33 + left.W * right.M43, left.X * right.M14 + left.Y * right.M24 + left.Z * right.M34 + left.W * right.M44);
		}
		/// <summary>
	...
	public static partial class Vector
	{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f Multiply(Matrix2x4f matrix, Vector4f vector)
		{
			return new Vector2f(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z + matrix.M14 * vector.W, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z + matrix.M24 * vector.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3f Multiply(Matrix3x4f matrix, Vector4f vector)
		{
			return new Vector3f(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z + matrix.M14 * vector.W, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z + matrix.M24 * vector.W, matrix.M31 * vector.X + matrix.M32 * vector.Y + matrix.M33 * vector.Z + matrix.M34 * vector.W);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f Multiply(Matrix4x4f matrix, Vector4f vector)
		{
		...
		public static Vector4d Map(Vector4f value, Func<float, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4f Map(Vector4f value, Func<float, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4h Map(Vector4f value, Func<float, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4ul Map(Vector4f value, Func<float, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4l Map(Vector4f value, Func<float, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4ui Map(Vector4f value, Func<float, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4i Map(Vector4f value, Func<float, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4us Map(Vector4f value, Func<float, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4s Map(Vector4f value, Func<float, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4b Map(Vector4f value, Func<float, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector4sb Map(Vector4f value, Func<float, sbyte> mapping)
		{
