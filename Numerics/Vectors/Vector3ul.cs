...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector3ul"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector3ul"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		#endregion
		#region Pack
		public static long Pack(int xBits, int yBits, int zBits, Vector3ul vector)
		{
		...
		public static Vector3ul Unpack(int xBits, int yBits, int zBits, ulong bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 64, "xBits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 64, "yBits must be between 0 and 64 inclusive.");
			Contract.Requires(0 <= zBits && zBits <= 64, "zBits must be between 0 and 64 inclusive.");
			...
			z &= ((1UL << zBits) - 1);
			return new Vector3ul((ulong)x, (ulong)y, (ulong)z);
		}
		#endregion
		#region Operations
		/// <summary>
		...
		[CLSCompliant(false)]
		public static double Absolute(Vector3ul value)
		{
		...
		[CLSCompliant(false)]
		public static Vector3d Normalize(Vector3ul value)
		{
		...
		[CLSCompliant(false)]
		public static Vector3d Map(Vector3ul value, Func<ulong, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3f Map(Vector3ul value, Func<ulong, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3h Map(Vector3ul value, Func<ulong, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3ul Map(Vector3ul value, Func<ulong, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3l Map(Vector3ul value, Func<ulong, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3ui Map(Vector3ul value, Func<ulong, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3i Map(Vector3ul value, Func<ulong, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3us Map(Vector3ul value, Func<ulong, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3s Map(Vector3ul value, Func<ulong, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3b Map(Vector3ul value, Func<ulong, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3sb Map(Vector3ul value, Func<ulong, sbyte> mapping)
		{
		...
		[CLSCompliant(false)]
		public static SphericalCoordinate CartesianToSpherical (Vector3ul value)
		{
