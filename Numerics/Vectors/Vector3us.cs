...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		#region Binary
		/// <summary>
		/// Writes the given <see cref="Vector3us"/> to an <see cref="Ibasa.IO.BinaryWriter">.
		/// </summary>
		...
		/// <summary>
		/// Reads a <see cref="Vector3us"/> from an <see cref="Ibasa.IO.BinaryReader">.
		/// </summary>
		...
		#endregion
		#region Pack
		public static ulong Pack(int xBits, int yBits, int zBits, Vector3us vector)
		{
		...
		public static ulong Pack(Vector3us vector)
		{
		...
		public static Vector3us Unpack(int xBits, int yBits, int zBits, ushort bits)
		{
			Contract.Requires(0 <= xBits && xBits <= 16, "xBits must be between 0 and 16 inclusive.");
			Contract.Requires(0 <= yBits && yBits <= 16, "yBits must be between 0 and 16 inclusive.");
			Contract.Requires(0 <= zBits && zBits <= 16, "zBits must be between 0 and 16 inclusive.");
		...
		[CLSCompliant(false)]
		public static Vector3d Map(Vector3us value, Func<ushort, double> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3f Map(Vector3us value, Func<ushort, float> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3h Map(Vector3us value, Func<ushort, Half> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3ul Map(Vector3us value, Func<ushort, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3l Map(Vector3us value, Func<ushort, long> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3ui Map(Vector3us value, Func<ushort, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3i Map(Vector3us value, Func<ushort, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3us Map(Vector3us value, Func<ushort, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3s Map(Vector3us value, Func<ushort, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3b Map(Vector3us value, Func<ushort, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector3sb Map(Vector3us value, Func<ushort, sbyte> mapping)
		{
		...
		[CLSCompliant(false)]
		public static SphericalCoordinate CartesianToSpherical (Vector3us value)
		{
