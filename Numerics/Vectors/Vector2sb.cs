...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2ul Map(Vector2sb value, Func<sbyte, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2i Map(Vector2sb value, Func<sbyte, int> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2us Map(Vector2sb value, Func<sbyte, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2b Map(Vector2sb value, Func<sbyte, byte> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2sb Map(Vector2sb value, Func<sbyte, sbyte> mapping)
		{
