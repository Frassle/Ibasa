...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		public static Vector8d Map(Vector8d value, Func<double, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8f Map(Vector8d value, Func<double, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8h Map(Vector8d value, Func<double, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8ul Map(Vector8d value, Func<double, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8l Map(Vector8d value, Func<double, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8ui Map(Vector8d value, Func<double, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8i Map(Vector8d value, Func<double, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8us Map(Vector8d value, Func<double, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8s Map(Vector8d value, Func<double, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8b Map(Vector8d value, Func<double, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector8sb Map(Vector8d value, Func<double, sbyte> mapping)
		{
