...
namespace Ibasa.Numerics
{
	...
	public static partial class Vector
	{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2ul Map(Vector2us value, Func<ushort, ulong> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2ui Map(Vector2us value, Func<ushort, uint> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2us Map(Vector2us value, Func<ushort, ushort> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2s Map(Vector2us value, Func<ushort, short> mapping)
		{
		...
		/// <returns>The result of mapping each component of value.</returns>
		[CLSCompliant(false)]
		public static Vector2b Map(Vector2us value, Func<ushort, byte> mapping)
		{
