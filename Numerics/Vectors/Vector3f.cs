...
namespace Ibasa.Numerics
{
	...
	public struct Vector3f: IEquatable<Vector3f>, IFormattable
	{
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f operator *(Matrix2x3f left, Vector3f right)
		{
			return new Vector2f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f operator *(Vector3f left, Matrix3x2f right)
		{
			return new Vector2f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3f operator *(Matrix3x3f left, Vector3f right)
		{
			return new Vector3f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		{
			return new Vector3f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f operator *(Matrix4x3f left, Vector3f right)
		{
			return new Vector4f(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z, left.M41 * right.X + left.M42 * right.Y + left.M43 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f operator *(Vector3f left, Matrix3x4f right)
		{
			return new Vector4f(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33, left.X * right.M14 + left.Y * right.M24 + left.Z * right.M34);
		}
		/// <summary>
	...
	public static partial class Vector
	{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2f Multiply(Matrix2x3f matrix, Vector3f vector)
		{
			return new Vector2f(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3f Multiply(Matrix3x3f matrix, Vector3f vector)
		{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4f Multiply(Matrix4x3f matrix, Vector3f vector)
		{
			return new Vector4f(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z, matrix.M31 * vector.X + matrix.M32 * vector.Y + matrix.M33 * vector.Z, matrix.M41 * vector.X + matrix.M42 * vector.Y + matrix.M43 * vector.Z);
		}
		/// <summary>
		/// Divides a vector by a scalar and returns the result.
		/// </summary>
		...
		public static Vector3d Map(Vector3f value, Func<float, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3f Map(Vector3f value, Func<float, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3h Map(Vector3f value, Func<float, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ul Map(Vector3f value, Func<float, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3l Map(Vector3f value, Func<float, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ui Map(Vector3f value, Func<float, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3i Map(Vector3f value, Func<float, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3us Map(Vector3f value, Func<float, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3s Map(Vector3f value, Func<float, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3b Map(Vector3f value, Func<float, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3sb Map(Vector3f value, Func<float, sbyte> mapping)
		{
		...
		public static SphericalCoordinate CartesianToSpherical (Vector3f value)
		{
