...
namespace Ibasa.Numerics
{
	...
	public struct Vector3d: IEquatable<Vector3d>, IFormattable
	{
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d operator *(Matrix2x3d left, Vector3d right)
		{
			return new Vector2d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d operator *(Vector3d left, Matrix3x2d right)
		{
			return new Vector2d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		{
			return new Vector3d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		{
			return new Vector3d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="right">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d operator *(Matrix4x3d left, Vector3d right)
		{
			return new Vector4d(left.M11 * right.X + left.M12 * right.Y + left.M13 * right.Z, left.M21 * right.X + left.M22 * right.Y + left.M23 * right.Z, left.M31 * right.X + left.M32 * right.Y + left.M33 * right.Z, left.M41 * right.X + left.M42 * right.Y + left.M43 * right.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="left">The matrix to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d operator *(Vector3d left, Matrix3x4d right)
		{
			return new Vector4d(left.X * right.M11 + left.Y * right.M21 + left.Z * right.M31, left.X * right.M12 + left.Y * right.M22 + left.Z * right.M32, left.X * right.M13 + left.Y * right.M23 + left.Z * right.M33, left.X * right.M14 + left.Y * right.M24 + left.Z * right.M34);
		}
		/// <summary>
	...
	public static partial class Vector
	{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector2d Multiply(Matrix2x3d matrix, Vector3d vector)
		{
			return new Vector2d(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z);
		}
		/// <summary>
		/// Returns the product of a matrix and vector.
		/// </summary>
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector3d Multiply(Matrix3x3d matrix, Vector3d vector)
		{
		...
		/// <param name="vector">The vector to multiply.</param>
		/// <returns>The product of the left and right parameters.</returns>
		public static Vector4d Multiply(Matrix4x3d matrix, Vector3d vector)
		{
			return new Vector4d(matrix.M11 * vector.X + matrix.M12 * vector.Y + matrix.M13 * vector.Z, matrix.M21 * vector.X + matrix.M22 * vector.Y + matrix.M23 * vector.Z, matrix.M31 * vector.X + matrix.M32 * vector.Y + matrix.M33 * vector.Z, matrix.M41 * vector.X + matrix.M42 * vector.Y + matrix.M43 * vector.Z);
		}
		/// <summary>
		/// Divides a vector by a scalar and returns the result.
		/// </summary>
		...
		public static Vector3d Map(Vector3d value, Func<double, double> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3f Map(Vector3d value, Func<double, float> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3h Map(Vector3d value, Func<double, Half> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ul Map(Vector3d value, Func<double, ulong> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3l Map(Vector3d value, Func<double, long> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3ui Map(Vector3d value, Func<double, uint> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3i Map(Vector3d value, Func<double, int> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3us Map(Vector3d value, Func<double, ushort> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3s Map(Vector3d value, Func<double, short> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3b Map(Vector3d value, Func<double, byte> mapping)
		{
		...
		/// <param name="mapping">A mapping function to apply to each component.</param>
		/// <returns>The result of mapping each component of value.</returns>
		public static Vector3sb Map(Vector3d value, Func<double, sbyte> mapping)
		{
		...
		public static SphericalCoordinate CartesianToSpherical (Vector3d value)
		{
		...
		public static Vector3d SphericalToCartesian (SphericalCoordinate value)
		{
			return new Vector3d(
