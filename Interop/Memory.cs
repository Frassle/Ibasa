...
namespace Ibasa.Interop
{
    ...
    public static class Memory
    {
        ...
        public static unsafe void* Write<T>(void* dst, ref T value)
        {
            throw new NotImplementedException();
        }

        public static unsafe void* Read<T>(void* src, out T value)
        {
            throw new NotImplementedException();
        }
        ...
        public static unsafe IntPtr Write<T>(IntPtr dst, ref T value)
        {
            return new IntPtr(Write(dst.ToPointer(), ref value));
        }

        public static unsafe IntPtr Read<T>(IntPtr src, out T value)
        {
