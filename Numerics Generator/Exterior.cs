...
namespace Numerics_Generator
{
    class Exterior : Generator
    {
        ...
        public Exterior(NumberType type, int dimension, Grade grade)
        {
            Type = type;
            Dimension = dimension;
            Grade = grade;

            Components = Component.Components(Grade.Elements);
        }

        public string Name { get { return Grade.Name == "Scalar" ? Type.Name : Grade.Name + Dimension + Type.Suffix; } }
        ...
        {
            WriteLine("/// <summary>");
            WriteLine("/// Represents a {0} dimensional {1} of {2}s.", Dimension.Name(), Name, Type);
            WriteLine("/// </summary>");
        ...
        void Constants()
        {
            ...
            {
                var vector = Component.UnitVector(Components.Length, component.Index);
        ...
        void Functions()
        {
            ...
            WriteLine("/// </summary>");
            WriteLine("public static void Write(this System.IO.BinaryWriter writer, {0} vector)", Name);
            WriteLine("{");
            Indent();
            foreach(var component in Components)
            {
